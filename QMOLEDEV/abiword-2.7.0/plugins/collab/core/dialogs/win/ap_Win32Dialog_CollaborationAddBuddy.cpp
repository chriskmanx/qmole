...
static void s_ok_clicked(GtkWidget * wid, AP_Win32Dialog_CollaborationAddBuddy * dlg)
{
	dlg->event_Ok();
}
//*/
XAP_Dialog * AP_Win32Dialog_CollaborationAddBuddy::static_constructor(XAP_DialogFactory * pFactory, XAP_Dialog_Id id)
{
	return static_cast<XAP_Dialog *>(new AP_Win32Dialog_CollaborationAddBuddy(pFactory, id));
}
pt2Constructor ap_Dialog_CollaborationAddBuddy_Constructor = &AP_Win32Dialog_CollaborationAddBuddy::static_constructor;


AP_Win32Dialog_CollaborationAddBuddy::AP_Win32Dialog_CollaborationAddBuddy(XAP_DialogFactory * pDlgFactory, XAP_Dialog_Id id)
...
void AP_Win32Dialog_CollaborationAddBuddy::runModal(XAP_Frame * pFrame)
{
								 ...
								 pFrame, this, GTK_RESPONSE_CANCEL, false ) )
	{
		case GTK_RESPONSE_CANCEL:
			m_answer = AP_Win32Dialog_CollaborationAddBuddy::a_CANCEL;
			break;
		case GTK_RESPONSE_OK:
			m_answer = AP_Win32Dialog_CollaborationAddBuddy::a_OK;
			break;			
		default:
			m_answer = AP_Win32Dialog_CollaborationAddBuddy::a_CANCEL;
			break;
...
/*
GtkWidget * AP_Win32Dialog_CollaborationAddBuddy::_constructWindow(void)
{
	GtkWidget* window;
	...
	window = GTK_WIDGET(gtk_builder_get_object(builder, "ap_Win32Dialog_CollaborationAddBuddy"));
...
void AP_Win32Dialog_CollaborationAddBuddy::_populateWindowData()
{
...
void AP_Win32Dialog_CollaborationAddBuddy::event_Ok()
{
	GtkTreeIter iter;
