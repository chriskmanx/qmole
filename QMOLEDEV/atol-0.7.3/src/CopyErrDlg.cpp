...
GtkWidget* CopyErrDlg::create_dialog ()
{
	...
	gtk_window_set_title (GTK_WINDOW (err_dialog), _("Copy Error"));
...
{
	gtk_dialog_response(GTK_DIALOG(user_data), OPF_CPY_ERR_SKIP_ALL);
}
