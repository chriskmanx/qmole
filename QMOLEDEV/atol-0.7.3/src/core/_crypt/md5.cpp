...
CMD5::CMD5()
{
	m_digest[0]	= '\0';		//reset digest content
	m_digestString[32]=0;	//the digest string is always 32 characters
}
...
void CMD5::MD5Final() 
{
	...
	Encode((unsigned char *)m_digest, m_context.state, 16);
...
const unsigned char* CMD5::GetDigestBinary()
{
	return m_digest;
}
