...
const unsigned AbstractMethodErrorMessage = 4;

#define HAVE_AbstractMethodErrorMessage 1

const unsigned AbstractMethodErrorTrace = 8;

#define HAVE_AbstractMethodErrorTrace 1

const unsigned AbstractMethodErrorCause = 12;

#define HAVE_AbstractMethodErrorCause 1

const unsigned AddendumPool = 4;

#define HAVE_AddendumPool 1

const unsigned AddendumAnnotationTable = 8;

#define HAVE_AddendumAnnotationTable 1

const unsigned AddendumSignature = 12;

#define HAVE_AddendumSignature 1

const unsigned ArithmeticExceptionMessage = 4;

#define HAVE_ArithmeticExceptionMessage 1

const unsigned ArithmeticExceptionTrace = 8;

#define HAVE_ArithmeticExceptionTrace 1

const unsigned ArithmeticExceptionCause = 12;

#define HAVE_ArithmeticExceptionCause 1

const unsigned ArrayLength = 4;

#define HAVE_ArrayLength 1

const unsigned ArrayBody = 8;

#define HAVE_ArrayBody 1

const unsigned ArrayIndexOutOfBoundsExceptionMessage = 4;

#define HAVE_ArrayIndexOutOfBoundsExceptionMessage 1

const unsigned ArrayIndexOutOfBoundsExceptionTrace = 8;

#define HAVE_ArrayIndexOutOfBoundsExceptionTrace 1

const unsigned ArrayIndexOutOfBoundsExceptionCause = 12;

#define HAVE_ArrayIndexOutOfBoundsExceptionCause 1

const unsigned ArrayStoreExceptionMessage = 4;

#define HAVE_ArrayStoreExceptionMessage 1

const unsigned ArrayStoreExceptionTrace = 8;

#define HAVE_ArrayStoreExceptionTrace 1

const unsigned ArrayStoreExceptionCause = 12;

#define HAVE_ArrayStoreExceptionCause 1

const unsigned BooleanValue = 4;

#define HAVE_BooleanValue 1

const unsigned BooleanArrayLength = 4;

#define HAVE_BooleanArrayLength 1

const unsigned BooleanArrayBody = 8;

#define HAVE_BooleanArrayBody 1

const unsigned ByteValue = 4;

#define HAVE_ByteValue 1

const unsigned ByteArrayLength = 4;

#define HAVE_ByteArrayLength 1

const unsigned ByteArrayBody = 8;

#define HAVE_ByteArrayBody 1

const unsigned CallNodeAddress = 4;

#define HAVE_CallNodeAddress 1

const unsigned CallNodeTarget = 8;

#define HAVE_CallNodeTarget 1

const unsigned CallNodeFlags = 12;

#define HAVE_CallNodeFlags 1

const unsigned CallNodeNext = 16;

#define HAVE_CallNodeNext 1

const unsigned CharValue = 4;

#define HAVE_CharValue 1

const unsigned CharArrayLength = 4;

#define HAVE_CharArrayLength 1

const unsigned CharArrayBody = 8;

#define HAVE_CharArrayBody 1

const unsigned ClassFlags = 4;

#define HAVE_ClassFlags 1

const unsigned ClassVmFlags = 6;

#define HAVE_ClassVmFlags 1

const unsigned ClassFixedSize = 8;

#define HAVE_ClassFixedSize 1

const unsigned ClassArrayElementSize = 10;

#define HAVE_ClassArrayElementSize 1

const unsigned ClassArrayDimensions = 11;

#define HAVE_ClassArrayDimensions 1

const unsigned ClassArrayElementClass = 12;

#define HAVE_ClassArrayElementClass 1

const unsigned ClassRuntimeDataIndex = 16;

#define HAVE_ClassRuntimeDataIndex 1

const unsigned ClassObjectMask = 20;

#define HAVE_ClassObjectMask 1

const unsigned ClassName = 24;

#define HAVE_ClassName 1

const unsigned ClassSourceFile = 28;

#define HAVE_ClassSourceFile 1

const unsigned ClassSuper = 32;

#define HAVE_ClassSuper 1

const unsigned ClassInterfaceTable = 36;

#define HAVE_ClassInterfaceTable 1

const unsigned ClassVirtualTable = 40;

#define HAVE_ClassVirtualTable 1

const unsigned ClassFieldTable = 44;

#define HAVE_ClassFieldTable 1

const unsigned ClassMethodTable = 48;

#define HAVE_ClassMethodTable 1

const unsigned ClassAddendum = 52;

#define HAVE_ClassAddendum 1

const unsigned ClassStaticTable = 56;

#define HAVE_ClassStaticTable 1

const unsigned ClassLoader = 60;

#define HAVE_ClassLoader 1

const unsigned ClassSource = 64;

#define HAVE_ClassSource 1

const unsigned ClassLength = 68;

#define HAVE_ClassLength 1

const unsigned ClassVtable = 72;

#define HAVE_ClassVtable 1

const unsigned ClassAddendumPool = 4;

#define HAVE_ClassAddendumPool 1

const unsigned ClassAddendumAnnotationTable = 8;

#define HAVE_ClassAddendumAnnotationTable 1

const unsigned ClassAddendumSignature = 12;

#define HAVE_ClassAddendumSignature 1

const unsigned ClassAddendumInterfaceTable = 16;

#define HAVE_ClassAddendumInterfaceTable 1

const unsigned ClassAddendumInnerClassTable = 20;

#define HAVE_ClassAddendumInnerClassTable 1

const unsigned ClassAddendumDeclaredMethodCount = 24;

#define HAVE_ClassAddendumDeclaredMethodCount 1

const unsigned ClassAddendumEnclosingClass = 28;

#define HAVE_ClassAddendumEnclosingClass 1

const unsigned ClassAddendumEnclosingMethod = 32;

#define HAVE_ClassAddendumEnclosingMethod 1

const unsigned ClassCastExceptionMessage = 4;

#define HAVE_ClassCastExceptionMessage 1

const unsigned ClassCastExceptionTrace = 8;

#define HAVE_ClassCastExceptionTrace 1

const unsigned ClassCastExceptionCause = 12;

#define HAVE_ClassCastExceptionCause 1

const unsigned ClassLoaderParent = 4;

#define HAVE_ClassLoaderParent 1

const unsigned ClassLoaderPackages = 8;

#define HAVE_ClassLoaderPackages 1

const unsigned ClassLoaderMap = 12;

#define HAVE_ClassLoaderMap 1

const unsigned ClassNotFoundExceptionMessage = 4;

#define HAVE_ClassNotFoundExceptionMessage 1

const unsigned ClassNotFoundExceptionTrace = 8;

#define HAVE_ClassNotFoundExceptionTrace 1

const unsigned ClassNotFoundExceptionCause = 12;

#define HAVE_ClassNotFoundExceptionCause 1

const unsigned ClassNotFoundExceptionCause2 = 16;

#define HAVE_ClassNotFoundExceptionCause2 1

const unsigned ClassRuntimeDataArrayClass = 4;

#define HAVE_ClassRuntimeDataArrayClass 1

const unsigned ClassRuntimeDataJclass = 8;

#define HAVE_ClassRuntimeDataJclass 1

const unsigned ClassRuntimeDataPool = 12;

#define HAVE_ClassRuntimeDataPool 1

const unsigned ClassRuntimeDataSigners = 16;

#define HAVE_ClassRuntimeDataSigners 1

const unsigned CleanerQueueNext = 4;

#define HAVE_CleanerQueueNext 1

const unsigned CloneNotSupportedExceptionMessage = 4;

#define HAVE_CloneNotSupportedExceptionMessage 1

const unsigned CloneNotSupportedExceptionTrace = 8;

#define HAVE_CloneNotSupportedExceptionTrace 1

const unsigned CloneNotSupportedExceptionCause = 12;

#define HAVE_CloneNotSupportedExceptionCause 1

const unsigned CodePool = 4;

#define HAVE_CodePool 1

const unsigned CodeStackMap = 8;

#define HAVE_CodeStackMap 1

const unsigned CodeExceptionHandlerTable = 12;

#define HAVE_CodeExceptionHandlerTable 1

const unsigned CodeLineNumberTable = 16;

#define HAVE_CodeLineNumberTable 1

const unsigned CodeCompiled = 20;

#define HAVE_CodeCompiled 1

const unsigned CodeCompiledSize = 24;

#define HAVE_CodeCompiledSize 1

const unsigned CodeMaxStack = 28;

#define HAVE_CodeMaxStack 1

const unsigned CodeMaxLocals = 30;

#define HAVE_CodeMaxLocals 1

const unsigned CodeLength = 32;

#define HAVE_CodeLength 1

const unsigned CodeBody = 36;

#define HAVE_CodeBody 1

const unsigned CompileRootsCallTable = 4;

#define HAVE_CompileRootsCallTable 1

const unsigned CompileRootsMethodTree = 8;

#define HAVE_CompileRootsMethodTree 1

const unsigned CompileRootsMethodTreeSentinal = 12;

#define HAVE_CompileRootsMethodTreeSentinal 1

const unsigned CompileRootsObjectPools = 16;

#define HAVE_CompileRootsObjectPools 1

const unsigned CompileRootsStaticTableArray = 20;

#define HAVE_CompileRootsStaticTableArray 1

const unsigned CompileRootsVirtualThunks = 24;

#define HAVE_CompileRootsVirtualThunks 1

const unsigned CompileRootsReceiveMethod = 28;

#define HAVE_CompileRootsReceiveMethod 1

const unsigned CompileRootsWindMethod = 32;

#define HAVE_CompileRootsWindMethod 1

const unsigned CompileRootsRewindMethod = 36;

#define HAVE_CompileRootsRewindMethod 1

const unsigned ContinuationNext = 4;

#define HAVE_ContinuationNext 1

const unsigned ContinuationContext = 8;

#define HAVE_ContinuationContext 1

const unsigned ContinuationMethod = 12;

#define HAVE_ContinuationMethod 1

const unsigned ContinuationAddress = 16;

#define HAVE_ContinuationAddress 1

const unsigned ContinuationReturnAddressOffset = 20;

#define HAVE_ContinuationReturnAddressOffset 1

const unsigned ContinuationFramePointerOffset = 24;

#define HAVE_ContinuationFramePointerOffset 1

const unsigned ContinuationLength = 28;

#define HAVE_ContinuationLength 1

const unsigned ContinuationBody = 32;

#define HAVE_ContinuationBody 1

const unsigned ContinuationContextNext = 4;

#define HAVE_ContinuationContextNext 1

const unsigned ContinuationContextBefore = 8;

#define HAVE_ContinuationContextBefore 1

const unsigned ContinuationContextAfter = 12;

#define HAVE_ContinuationContextAfter 1

const unsigned ContinuationContextContinuation = 16;

#define HAVE_ContinuationContextContinuation 1

const unsigned ContinuationContextMethod = 20;
...
const unsigned DoubleArrayLength = 4;

#define HAVE_DoubleArrayLength 1

const unsigned DoubleArrayBody = 8;

#define HAVE_DoubleArrayBody 1

const unsigned ErrorMessage = 4;

#define HAVE_ErrorMessage 1

const unsigned ErrorTrace = 8;

#define HAVE_ErrorTrace 1

const unsigned ErrorCause = 12;

#define HAVE_ErrorCause 1

const unsigned ExceptionMessage = 4;

#define HAVE_ExceptionMessage 1

const unsigned ExceptionTrace = 8;

#define HAVE_ExceptionTrace 1

const unsigned ExceptionCause = 12;

#define HAVE_ExceptionCause 1

const unsigned ExceptionHandlerTableLength = 4;

#define HAVE_ExceptionHandlerTableLength 1

const unsigned ExceptionHandlerTableBody = 8;

#define HAVE_ExceptionHandlerTableBody 1

const unsigned ExceptionInInitializerErrorMessage = 4;

#define HAVE_ExceptionInInitializerErrorMessage 1

const unsigned ExceptionInInitializerErrorTrace = 8;

#define HAVE_ExceptionInInitializerErrorTrace 1

const unsigned ExceptionInInitializerErrorCause = 12;

#define HAVE_ExceptionInInitializerErrorCause 1

const unsigned ExceptionInInitializerErrorException = 16;

#define HAVE_ExceptionInInitializerErrorException 1

const unsigned FieldVmFlags = 4;

#define HAVE_FieldVmFlags 1

const unsigned FieldCode = 5;

#define HAVE_FieldCode 1

const unsigned FieldFlags = 6;

#define HAVE_FieldFlags 1

const unsigned FieldOffset = 8;

#define HAVE_FieldOffset 1

const unsigned FieldNativeID = 12;

#define HAVE_FieldNativeID 1

const unsigned FieldName = 16;

#define HAVE_FieldName 1

const unsigned FieldSpec = 20;

#define HAVE_FieldSpec 1

const unsigned FieldAddendum = 24;

#define HAVE_FieldAddendum 1

const unsigned FieldClass = 28;

#define HAVE_FieldClass 1

const unsigned FieldAddendumPool = 4;

#define HAVE_FieldAddendumPool 1

const unsigned FieldAddendumAnnotationTable = 8;

#define HAVE_FieldAddendumAnnotationTable 1

const unsigned FieldAddendumSignature = 12;

#define HAVE_FieldAddendumSignature 1

const unsigned FileNotFoundExceptionMessage = 4;

#define HAVE_FileNotFoundExceptionMessage 1

const unsigned FileNotFoundExceptionTrace = 8;

#define HAVE_FileNotFoundExceptionTrace 1

const unsigned FileNotFoundExceptionCause = 12;

#define HAVE_FileNotFoundExceptionCause 1

const unsigned FinalizerTarget = 4;

#define HAVE_FinalizerTarget 1

const unsigned FinalizerFinalize = 8;

#define HAVE_FinalizerFinalize 1

const unsigned FinalizerNext = 12;

#define HAVE_FinalizerNext 1

const unsigned FinalizerQueueTarget = 16;

#define HAVE_FinalizerQueueTarget 1

const unsigned FinalizerQueueNext = 20;

#define HAVE_FinalizerQueueNext 1

const unsigned FinderFinder = 4;

#define HAVE_FinderFinder 1

const unsigned FinderName = 8;

#define HAVE_FinderName 1

const unsigned FinderNext = 12;

#define HAVE_FinderNext 1

const unsigned FloatValue = 4;

#define HAVE_FloatValue 1

const unsigned FloatArrayLength = 4;

#define HAVE_FloatArrayLength 1

const unsigned FloatArrayBody = 8;

#define HAVE_FloatArrayBody 1

const unsigned HashMapSize = 4;

#define HAVE_HashMapSize 1

const unsigned HashMapArray = 8;

#define HAVE_HashMapArray 1

const unsigned IllegalArgumentExceptionMessage = 4;

#define HAVE_IllegalArgumentExceptionMessage 1

const unsigned IllegalArgumentExceptionTrace = 8;

#define HAVE_IllegalArgumentExceptionTrace 1

const unsigned IllegalArgumentExceptionCause = 12;

#define HAVE_IllegalArgumentExceptionCause 1

const unsigned IllegalMonitorStateExceptionMessage = 4;

#define HAVE_IllegalMonitorStateExceptionMessage 1

const unsigned IllegalMonitorStateExceptionTrace = 8;

#define HAVE_IllegalMonitorStateExceptionTrace 1

const unsigned IllegalMonitorStateExceptionCause = 12;

#define HAVE_IllegalMonitorStateExceptionCause 1

const unsigned IllegalStateExceptionMessage = 4;

#define HAVE_IllegalStateExceptionMessage 1

const unsigned IllegalStateExceptionTrace = 8;

#define HAVE_IllegalStateExceptionTrace 1

const unsigned IllegalStateExceptionCause = 12;

#define HAVE_IllegalStateExceptionCause 1

const unsigned IncompatibleClassChangeErrorMessage = 4;

#define HAVE_IncompatibleClassChangeErrorMessage 1

const unsigned IncompatibleClassChangeErrorTrace = 8;

#define HAVE_IncompatibleClassChangeErrorTrace 1

const unsigned IncompatibleClassChangeErrorCause = 12;

#define HAVE_IncompatibleClassChangeErrorCause 1

const unsigned IncompatibleContinuationExceptionMessage = 4;

#define HAVE_IncompatibleContinuationExceptionMessage 1

const unsigned IncompatibleContinuationExceptionTrace = 8;

#define HAVE_IncompatibleContinuationExceptionTrace 1

const unsigned IncompatibleContinuationExceptionCause = 12;

#define HAVE_IncompatibleContinuationExceptionCause 1

const unsigned IndexOutOfBoundsExceptionMessage = 4;

#define HAVE_IndexOutOfBoundsExceptionMessage 1

const unsigned IndexOutOfBoundsExceptionTrace = 8;

#define HAVE_IndexOutOfBoundsExceptionTrace 1

const unsigned IndexOutOfBoundsExceptionCause = 12;

#define HAVE_IndexOutOfBoundsExceptionCause 1

const unsigned InnerClassReferenceInner = 4;

#define HAVE_InnerClassReferenceInner 1

const unsigned InnerClassReferenceOuter = 8;

#define HAVE_InnerClassReferenceOuter 1

const unsigned InnerClassReferenceName = 12;

#define HAVE_InnerClassReferenceName 1

const unsigned InnerClassReferenceFlags = 16;

#define HAVE_InnerClassReferenceFlags 1

const unsigned IntValue = 4;

#define HAVE_IntValue 1

const unsigned IntArrayLength = 4;

#define HAVE_IntArrayLength 1

const unsigned IntArrayBody = 8;

#define HAVE_IntArrayBody 1

const unsigned InterruptedExceptionMessage = 4;

#define HAVE_InterruptedExceptionMessage 1

const unsigned InterruptedExceptionTrace = 8;

#define HAVE_InterruptedExceptionTrace 1

const unsigned InterruptedExceptionCause = 12;

#define HAVE_InterruptedExceptionCause 1

const unsigned InvocationBootstrap = 4;

#define HAVE_InvocationBootstrap 1

const unsigned InvocationIndex = 8;

#define HAVE_InvocationIndex 1

const unsigned InvocationClass = 12;

#define HAVE_InvocationClass 1

const unsigned InvocationPool = 16;

#define HAVE_InvocationPool 1

const unsigned InvocationTemplate = 20;

#define HAVE_InvocationTemplate 1

const unsigned InvocationSite = 24;

#define HAVE_InvocationSite 1

const unsigned InvocationTargetExceptionMessage = 4;

#define HAVE_InvocationTargetExceptionMessage 1

const unsigned InvocationTargetExceptionTrace = 8;

#define HAVE_InvocationTargetExceptionTrace 1

const unsigned InvocationTargetExceptionCause = 12;

#define HAVE_InvocationTargetExceptionCause 1

const unsigned InvocationTargetExceptionTarget = 16;

#define HAVE_InvocationTargetExceptionTarget 1

const unsigned IoExceptionMessage = 4;

#define HAVE_IoExceptionMessage 1

const unsigned IoExceptionTrace = 8;

#define HAVE_IoExceptionTrace 1

const unsigned IoExceptionCause = 12;

#define HAVE_IoExceptionCause 1

const unsigned JclassVmClass = 4;

#define HAVE_JclassVmClass 1

const unsigned JconstructorMethod = 4;

#define HAVE_JconstructorMethod 1

const unsigned JfieldVmField = 4;

#define HAVE_JfieldVmField 1

const unsigned JfieldAccessible = 8;

#define HAVE_JfieldAccessible 1

const unsigned JmethodVmMethod = 4;

#define HAVE_JmethodVmMethod 1

const unsigned JmethodAccessible = 8;

#define HAVE_JmethodAccessible 1

const unsigned JreferenceVmNext = 4;

#define HAVE_JreferenceVmNext 1

const unsigned JreferenceTarget = 8;

#define HAVE_JreferenceTarget 1

const unsigned JreferenceQueue = 12;

#define HAVE_JreferenceQueue 1

const unsigned JreferenceJNext = 16;

#define HAVE_JreferenceJNext 1

const unsigned LineNumberTableLength = 4;

#define HAVE_LineNumberTableLength 1

const unsigned LineNumberTableBody = 8;

#define HAVE_LineNumberTableBody 1

const unsigned LinkageErrorMessage = 4;

#define HAVE_LinkageErrorMessage 1

const unsigned LinkageErrorTrace = 8;

#define HAVE_LinkageErrorTrace 1

const unsigned LinkageErrorCause = 12;

#define HAVE_LinkageErrorCause 1

const unsigned ListSize = 4;

#define HAVE_ListSize 1

const unsigned ListFront = 8;

#define HAVE_ListFront 1

const unsigned ListRear = 12;
...
const unsigned LongArrayLength = 4;

#define HAVE_LongArrayLength 1

const unsigned LongArrayBody = 8;

#define HAVE_LongArrayBody 1

const unsigned MethodVmFlags = 4;

#define HAVE_MethodVmFlags 1

const unsigned MethodReturnCode = 5;

#define HAVE_MethodReturnCode 1

const unsigned MethodParameterCount = 6;

#define HAVE_MethodParameterCount 1

const unsigned MethodParameterFootprint = 7;

#define HAVE_MethodParameterFootprint 1

const unsigned MethodFlags = 8;

#define HAVE_MethodFlags 1

const unsigned MethodOffset = 10;

#define HAVE_MethodOffset 1

const unsigned MethodNativeID = 12;

#define HAVE_MethodNativeID 1

const unsigned MethodRuntimeDataIndex = 16;

#define HAVE_MethodRuntimeDataIndex 1

const unsigned MethodName = 20;

#define HAVE_MethodName 1

const unsigned MethodSpec = 24;

#define HAVE_MethodSpec 1

const unsigned MethodAddendum = 28;

#define HAVE_MethodAddendum 1

const unsigned MethodClass = 32;

#define HAVE_MethodClass 1

const unsigned MethodCode = 36;

#define HAVE_MethodCode 1

const unsigned MethodAddendumPool = 4;

#define HAVE_MethodAddendumPool 1

const unsigned MethodAddendumAnnotationTable = 8;

#define HAVE_MethodAddendumAnnotationTable 1

const unsigned MethodAddendumSignature = 12;

#define HAVE_MethodAddendumSignature 1

const unsigned MethodAddendumExceptionTable = 16;

#define HAVE_MethodAddendumExceptionTable 1

const unsigned MethodAddendumAnnotationDefault = 20;

#define HAVE_MethodAddendumAnnotationDefault 1

const unsigned MethodAddendumParameterAnnotationTable = 24;

#define HAVE_MethodAddendumParameterAnnotationTable 1

const unsigned MethodRuntimeDataNative = 4;

#define HAVE_MethodRuntimeDataNative 1

const unsigned MonitorOwner = 4;

#define HAVE_MonitorOwner 1

const unsigned MonitorWaitHead = 8;

#define HAVE_MonitorWaitHead 1

const unsigned MonitorWaitTail = 12;

#define HAVE_MonitorWaitTail 1

const unsigned MonitorAcquireHead = 16;

#define HAVE_MonitorAcquireHead 1

const unsigned MonitorAcquireTail = 20;

#define HAVE_MonitorAcquireTail 1

const unsigned MonitorDepth = 24;

#define HAVE_MonitorDepth 1

const unsigned MonitorNodeValue = 4;

#define HAVE_MonitorNodeValue 1

const unsigned MonitorNodeNext = 8;

#define HAVE_MonitorNodeNext 1

const unsigned NativeFunction = 4;

#define HAVE_NativeFunction 1

const unsigned NativeFast = 8;

#define HAVE_NativeFast 1

const unsigned NativeInterceptFunction = 4;

#define HAVE_NativeInterceptFunction 1

const unsigned NativeInterceptFast = 8;

#define HAVE_NativeInterceptFast 1

const unsigned NativeInterceptOriginal = 12;

#define HAVE_NativeInterceptOriginal 1

const unsigned NegativeArraySizeExceptionMessage = 4;

#define HAVE_NegativeArraySizeExceptionMessage 1

const unsigned NegativeArraySizeExceptionTrace = 8;

#define HAVE_NegativeArraySizeExceptionTrace 1

const unsigned NegativeArraySizeExceptionCause = 12;

#define HAVE_NegativeArraySizeExceptionCause 1

const unsigned NoClassDefFoundErrorMessage = 4;

#define HAVE_NoClassDefFoundErrorMessage 1

const unsigned NoClassDefFoundErrorTrace = 8;

#define HAVE_NoClassDefFoundErrorTrace 1

const unsigned NoClassDefFoundErrorCause = 12;

#define HAVE_NoClassDefFoundErrorCause 1

const unsigned NoSuchFieldErrorMessage = 4;

#define HAVE_NoSuchFieldErrorMessage 1

const unsigned NoSuchFieldErrorTrace = 8;

#define HAVE_NoSuchFieldErrorTrace 1

const unsigned NoSuchFieldErrorCause = 12;

#define HAVE_NoSuchFieldErrorCause 1

const unsigned NoSuchMethodErrorMessage = 4;

#define HAVE_NoSuchMethodErrorMessage 1

const unsigned NoSuchMethodErrorTrace = 8;

#define HAVE_NoSuchMethodErrorTrace 1

const unsigned NoSuchMethodErrorCause = 12;

#define HAVE_NoSuchMethodErrorCause 1

const unsigned NullPointerExceptionMessage = 4;

#define HAVE_NullPointerExceptionMessage 1

const unsigned NullPointerExceptionTrace = 8;

#define HAVE_NullPointerExceptionTrace 1

const unsigned NullPointerExceptionCause = 12;

#define HAVE_NullPointerExceptionCause 1

const unsigned OutOfMemoryErrorMessage = 4;

#define HAVE_OutOfMemoryErrorMessage 1

const unsigned OutOfMemoryErrorTrace = 8;

#define HAVE_OutOfMemoryErrorTrace 1

const unsigned OutOfMemoryErrorCause = 12;

#define HAVE_OutOfMemoryErrorCause 1

const unsigned PairFirst = 4;

#define HAVE_PairFirst 1

const unsigned PairSecond = 8;

#define HAVE_PairSecond 1

const unsigned PhantomReferenceVmNext = 4;

#define HAVE_PhantomReferenceVmNext 1

const unsigned PhantomReferenceTarget = 8;

#define HAVE_PhantomReferenceTarget 1

const unsigned PhantomReferenceQueue = 12;

#define HAVE_PhantomReferenceQueue 1

const unsigned PhantomReferenceJNext = 16;

#define HAVE_PhantomReferenceJNext 1

const unsigned PointerValue = 4;

#define HAVE_PointerValue 1

const unsigned ReferenceKind = 4;

#define HAVE_ReferenceKind 1

const unsigned ReferenceClass = 8;

#define HAVE_ReferenceClass 1

const unsigned ReferenceName = 12;

#define HAVE_ReferenceName 1

const unsigned ReferenceSpec = 16;

#define HAVE_ReferenceSpec 1

const unsigned ReferenceQueueFront = 4;

#define HAVE_ReferenceQueueFront 1

const unsigned ReferenceQueueJnext = 8;

#define HAVE_ReferenceQueueJnext 1

const unsigned ReflectiveOperationExceptionMessage = 4;

#define HAVE_ReflectiveOperationExceptionMessage 1

const unsigned ReflectiveOperationExceptionTrace = 8;

#define HAVE_ReflectiveOperationExceptionTrace 1

const unsigned ReflectiveOperationExceptionCause = 12;

#define HAVE_ReflectiveOperationExceptionCause 1

const unsigned RegionRegion = 4;

#define HAVE_RegionRegion 1

const unsigned RegionPosition = 8;

#define HAVE_RegionPosition 1

const unsigned RootsBootLoader = 4;

#define HAVE_RootsBootLoader 1

const unsigned RootsAppLoader = 8;

#define HAVE_RootsAppLoader 1

const unsigned RootsBootstrapClassMap = 12;

#define HAVE_RootsBootstrapClassMap 1

const unsigned RootsPackageMap = 16;

#define HAVE_RootsPackageMap 1

const unsigned RootsFindLoadedClassMethod = 20;

#define HAVE_RootsFindLoadedClassMethod 1

const unsigned RootsLoadClassMethod = 24;

#define HAVE_RootsLoadClassMethod 1

const unsigned RootsMonitorMap = 28;

#define HAVE_RootsMonitorMap 1

const unsigned RootsStringMap = 32;

#define HAVE_RootsStringMap 1

const unsigned RootsByteArrayMap = 36;

#define HAVE_RootsByteArrayMap 1

const unsigned RootsPoolMap = 40;

#define HAVE_RootsPoolMap 1

const unsigned RootsClassRuntimeDataTable = 44;

#define HAVE_RootsClassRuntimeDataTable 1

const unsigned RootsMethodRuntimeDataTable = 48;

#define HAVE_RootsMethodRuntimeDataTable 1

const unsigned RootsJNIMethodTable = 52;

#define HAVE_RootsJNIMethodTable 1

const unsigned RootsJNIFieldTable = 56;

#define HAVE_RootsJNIFieldTable 1

const unsigned RootsShutdownHooks = 60;

#define HAVE_RootsShutdownHooks 1

const unsigned RootsFinalizerThread = 64;

#define HAVE_RootsFinalizerThread 1

const unsigned RootsObjectsToFinalize = 68;

#define HAVE_RootsObjectsToFinalize 1

const unsigned RootsObjectsToClean = 72;

#define HAVE_RootsObjectsToClean 1

const unsigned RootsNullPointerException = 76;

#define HAVE_RootsNullPointerException 1

const unsigned RootsArithmeticException = 80;

#define HAVE_RootsArithmeticException 1

const unsigned RootsArrayIndexOutOfBoundsException = 84;

#define HAVE_RootsArrayIndexOutOfBoundsException 1

const unsigned RootsOutOfMemoryError = 88;

#define HAVE_RootsOutOfMemoryError 1

const unsigned RootsShutdownInProgress = 92;

#define HAVE_RootsShutdownInProgress 1

const unsigned RootsVirtualFileFinders = 96;

#define HAVE_RootsVirtualFileFinders 1

const unsigned RootsVirtualFiles = 100;

#define HAVE_RootsVirtualFiles 1

const unsigned RootsArrayInterfaceTable = 104;

#define HAVE_RootsArrayInterfaceTable 1

const unsigned RootsThreadTerminated = 108;

#define HAVE_RootsThreadTerminated 1

const unsigned RuntimeExceptionMessage = 4;

#define HAVE_RuntimeExceptionMessage 1

const unsigned RuntimeExceptionTrace = 8;

#define HAVE_RuntimeExceptionTrace 1

const unsigned RuntimeExceptionCause = 12;

#define HAVE_RuntimeExceptionCause 1

const unsigned ShortValue = 4;

#define HAVE_ShortValue 1

const unsigned ShortArrayLength = 4;

#define HAVE_ShortArrayLength 1

const unsigned ShortArrayBody = 8;

#define HAVE_ShortArrayBody 1

const unsigned SingletonLength = 4;

#define HAVE_SingletonLength 1

const unsigned SingletonBody = 8;

#define HAVE_SingletonBody 1

const unsigned SoftReferenceVmNext = 4;

#define HAVE_SoftReferenceVmNext 1

const unsigned SoftReferenceTarget = 8;

#define HAVE_SoftReferenceTarget 1

const unsigned SoftReferenceQueue = 12;

#define HAVE_SoftReferenceQueue 1

const unsigned SoftReferenceJNext = 16;

#define HAVE_SoftReferenceJNext 1

const unsigned StackOverflowErrorMessage = 4;

#define HAVE_StackOverflowErrorMessage 1

const unsigned StackOverflowErrorTrace = 8;

#define HAVE_StackOverflowErrorTrace 1

const unsigned StackOverflowErrorCause = 12;

#define HAVE_StackOverflowErrorCause 1

const unsigned StackTraceElementClass = 4;

#define HAVE_StackTraceElementClass 1

const unsigned StackTraceElementMethod = 8;

#define HAVE_StackTraceElementMethod 1

const unsigned StackTraceElementFile = 12;

#define HAVE_StackTraceElementFile 1

const unsigned StackTraceElementLine = 16;

#define HAVE_StackTraceElementLine 1

const unsigned StringData = 4;

#define HAVE_StringData 1

const unsigned StringOffset = 8;

#define HAVE_StringOffset 1

const unsigned StringLength = 12;

#define HAVE_StringLength 1

const unsigned StringHashCode = 16;

#define HAVE_StringHashCode 1

const unsigned SystemClassLoaderParent = 4;

#define HAVE_SystemClassLoaderParent 1

const unsigned SystemClassLoaderPackages = 8;

#define HAVE_SystemClassLoaderPackages 1

const unsigned SystemClassLoaderMap = 12;

#define HAVE_SystemClassLoaderMap 1

const unsigned SystemClassLoaderFinder = 16;

#define HAVE_SystemClassLoaderFinder 1

const unsigned ThreadParkBlocker = 4;

#define HAVE_ThreadParkBlocker 1

const unsigned ThreadPeer = 8;

#define HAVE_ThreadPeer 1

const unsigned ThreadInterrupted = 16;

#define HAVE_ThreadInterrupted 1

const unsigned ThreadUnparked = 17;

#define HAVE_ThreadUnparked 1

const unsigned ThreadDaemon = 18;

#define HAVE_ThreadDaemon 1

const unsigned ThreadState = 19;

#define HAVE_ThreadState 1

const unsigned ThreadPriority = 20;

#define HAVE_ThreadPriority 1

const unsigned ThreadTask = 24;

#define HAVE_ThreadTask 1

const unsigned ThreadLocals = 28;

#define HAVE_ThreadLocals 1

const unsigned ThreadSleepLock = 32;

#define HAVE_ThreadSleepLock 1

const unsigned ThreadClassLoader = 36;

#define HAVE_ThreadClassLoader 1

const unsigned ThreadExceptionHandler = 40;

#define HAVE_ThreadExceptionHandler 1

const unsigned ThreadName = 44;

#define HAVE_ThreadName 1

const unsigned ThreadGroup = 48;

#define HAVE_ThreadGroup 1

const unsigned ThreadInterruptLock = 52;

#define HAVE_ThreadInterruptLock 1

const unsigned ThreadGroupParent = 4;

#define HAVE_ThreadGroupParent 1

const unsigned ThreadGroupName = 8;

#define HAVE_ThreadGroupName 1

const unsigned ThreadGroupSubgroups = 12;

#define HAVE_ThreadGroupSubgroups 1

const unsigned ThrowableMessage = 4;

#define HAVE_ThrowableMessage 1

const unsigned ThrowableTrace = 8;

#define HAVE_ThrowableTrace 1

const unsigned ThrowableCause = 12;

#define HAVE_ThrowableCause 1

const unsigned TraceElementMethod = 4;

#define HAVE_TraceElementMethod 1

const unsigned TraceElementIp = 8;

#define HAVE_TraceElementIp 1

const unsigned TreeNodeValue = 4;

#define HAVE_TreeNodeValue 1

const unsigned TreeNodeLeft = 8;

#define HAVE_TreeNodeLeft 1

const unsigned TreeNodeRight = 12;

#define HAVE_TreeNodeRight 1

const unsigned TripleFirst = 4;

#define HAVE_TripleFirst 1

const unsigned TripleSecond = 8;

#define HAVE_TripleSecond 1

const unsigned TripleThird = 12;

#define HAVE_TripleThird 1

const unsigned UnsatisfiedLinkErrorMessage = 4;

#define HAVE_UnsatisfiedLinkErrorMessage 1

const unsigned UnsatisfiedLinkErrorTrace = 8;

#define HAVE_UnsatisfiedLinkErrorTrace 1

const unsigned UnsatisfiedLinkErrorCause = 12;

#define HAVE_UnsatisfiedLinkErrorCause 1

const unsigned UnwindResultContinuation = 4;

#define HAVE_UnwindResultContinuation 1

const unsigned UnwindResultResult = 8;

#define HAVE_UnwindResultResult 1

const unsigned UnwindResultException = 12;
...
const unsigned VectorBody = 12;

#define HAVE_VectorBody 1

const unsigned VirtualMachineErrorMessage = 4;

#define HAVE_VirtualMachineErrorMessage 1

const unsigned VirtualMachineErrorTrace = 8;

#define HAVE_VirtualMachineErrorTrace 1

const unsigned VirtualMachineErrorCause = 12;

#define HAVE_VirtualMachineErrorCause 1

const unsigned WeakHashMapSize = 4;

#define HAVE_WeakHashMapSize 1

const unsigned WeakHashMapArray = 8;

#define HAVE_WeakHashMapArray 1

const unsigned WeakReferenceVmNext = 4;

#define HAVE_WeakReferenceVmNext 1

const unsigned WeakReferenceTarget = 8;

#define HAVE_WeakReferenceTarget 1

const unsigned WeakReferenceQueue = 12;

#define HAVE_WeakReferenceQueue 1

const unsigned WeakReferenceJNext = 16;

#define HAVE_WeakReferenceJNext 1

const unsigned WordArrayLength = 4;

#define HAVE_WordArrayLength 1

const unsigned WordArrayBody = 8;

#define HAVE_WordArrayBody 1

const unsigned FixedSizeOfAbstractMethodError = 16;

const unsigned FixedSizeOfAddendum = 16;

const unsigned FixedSizeOfArithmeticException = 16;

const unsigned FixedSizeOfArray = 8;

const unsigned ArrayElementSizeOfArray = 4;

const unsigned FixedSizeOfArrayIndexOutOfBoundsException = 16;

const unsigned FixedSizeOfArrayStoreException = 16;

const unsigned FixedSizeOfBoolean = 5;

const unsigned FixedSizeOfBooleanArray = 8;

const unsigned ArrayElementSizeOfBooleanArray = 1;

const unsigned FixedSizeOfByte = 5;

const unsigned FixedSizeOfByteArray = 8;

const unsigned ArrayElementSizeOfByteArray = 1;

const unsigned FixedSizeOfCallNode = 20;

const unsigned FixedSizeOfChar = 6;

const unsigned FixedSizeOfCharArray = 8;

const unsigned ArrayElementSizeOfCharArray = 2;

const unsigned FixedSizeOfClass = 72;

const unsigned ArrayElementSizeOfClass = 4;

const unsigned FixedSizeOfClassAddendum = 36;

const unsigned FixedSizeOfClassCastException = 16;

const unsigned FixedSizeOfClassLoader = 16;

const unsigned FixedSizeOfClassNotFoundException = 20;

const unsigned FixedSizeOfClassRuntimeData = 20;

const unsigned FixedSizeOfCleaner = 8;

const unsigned FixedSizeOfCloneNotSupportedException = 16;

const unsigned FixedSizeOfCloneable = 4;

const unsigned FixedSizeOfCode = 36;

const unsigned ArrayElementSizeOfCode = 1;

const unsigned FixedSizeOfCompileRoots = 40;

const unsigned FixedSizeOfConstantPool = 4;

const unsigned FixedSizeOfContinuation = 32;

const unsigned ArrayElementSizeOfContinuation = 4;

const unsigned FixedSizeOfContinuationContext = 24;

const unsigned FixedSizeOfDouble = 16;

const unsigned FixedSizeOfDoubleArray = 8;

const unsigned ArrayElementSizeOfDoubleArray = 8;

const unsigned FixedSizeOfError = 16;

const unsigned FixedSizeOfException = 16;

const unsigned FixedSizeOfExceptionHandlerTable = 8;

const unsigned ArrayElementSizeOfExceptionHandlerTable = 8;

const unsigned FixedSizeOfExceptionInInitializerError = 20;

const unsigned FixedSizeOfField = 32;

const unsigned FixedSizeOfFieldAddendum = 16;

const unsigned FixedSizeOfFileNotFoundException = 16;

const unsigned FixedSizeOfFinalizer = 24;

const unsigned FixedSizeOfFinder = 16;

const unsigned FixedSizeOfFloat = 8;

const unsigned FixedSizeOfFloatArray = 8;

const unsigned ArrayElementSizeOfFloatArray = 4;

const unsigned FixedSizeOfHashMap = 12;

const unsigned FixedSizeOfIllegalArgumentException = 16;

const unsigned FixedSizeOfIllegalMonitorStateException = 16;

const unsigned FixedSizeOfIllegalStateException = 16;

const unsigned FixedSizeOfIncompatibleClassChangeError = 16;

const unsigned FixedSizeOfIncompatibleContinuationException = 16;

const unsigned FixedSizeOfIndexOutOfBoundsException = 16;

const unsigned FixedSizeOfInnerClassReference = 18;

const unsigned FixedSizeOfInt = 8;

const unsigned FixedSizeOfIntArray = 8;

const unsigned ArrayElementSizeOfIntArray = 4;

const unsigned FixedSizeOfInterruptedException = 16;

const unsigned FixedSizeOfInvocation = 28;

const unsigned FixedSizeOfInvocationTargetException = 20;

const unsigned FixedSizeOfIoException = 16;

const unsigned FixedSizeOfJaccessibleObject = 4;

const unsigned FixedSizeOfJboolean = 4;

const unsigned FixedSizeOfJbyte = 4;

const unsigned FixedSizeOfJchar = 4;

const unsigned FixedSizeOfJclass = 8;

const unsigned FixedSizeOfJconstructor = 8;

const unsigned FixedSizeOfJdouble = 4;

const unsigned FixedSizeOfJfield = 9;

const unsigned FixedSizeOfJfloat = 4;

const unsigned FixedSizeOfJint = 4;

const unsigned FixedSizeOfJlong = 4;

const unsigned FixedSizeOfJmethod = 9;

const unsigned FixedSizeOfJobject = 4;

const unsigned FixedSizeOfJreference = 20;

const unsigned FixedSizeOfJshort = 4;

const unsigned FixedSizeOfJvoid = 4;

const unsigned FixedSizeOfLineNumberTable = 8;

const unsigned ArrayElementSizeOfLineNumberTable = 8;

const unsigned FixedSizeOfLinkageError = 16;

const unsigned FixedSizeOfList = 16;

const unsigned FixedSizeOfLong = 16;

const unsigned FixedSizeOfLongArray = 8;

const unsigned ArrayElementSizeOfLongArray = 8;

const unsigned FixedSizeOfMethod = 40;

const unsigned FixedSizeOfMethodAddendum = 28;

const unsigned FixedSizeOfMethodRuntimeData = 8;

const unsigned FixedSizeOfMonitor = 28;

const unsigned FixedSizeOfMonitorNode = 12;

const unsigned FixedSizeOfNative = 9;

const unsigned FixedSizeOfNativeIntercept = 16;

const unsigned FixedSizeOfNegativeArraySizeException = 16;

const unsigned FixedSizeOfNoClassDefFoundError = 16;

const unsigned FixedSizeOfNoSuchFieldError = 16;

const unsigned FixedSizeOfNoSuchMethodError = 16;

const unsigned FixedSizeOfNullPointerException = 16;

const unsigned FixedSizeOfNumber = 4;

const unsigned FixedSizeOfOutOfMemoryError = 16;

const unsigned FixedSizeOfPair = 12;

const unsigned FixedSizeOfPhantomReference = 20;

const unsigned FixedSizeOfPointer = 8;

const unsigned FixedSizeOfReference = 20;

const unsigned FixedSizeOfReferenceQueue = 12;

const unsigned FixedSizeOfReflectiveOperationException = 16;

const unsigned FixedSizeOfRegion = 12;

const unsigned FixedSizeOfRoots = 112;

const unsigned FixedSizeOfRuntimeException = 16;

const unsigned FixedSizeOfSerializable = 4;

const unsigned FixedSizeOfShort = 6;

const unsigned FixedSizeOfShortArray = 8;

const unsigned ArrayElementSizeOfShortArray = 2;

const unsigned FixedSizeOfSingleton = 8;

const unsigned ArrayElementSizeOfSingleton = 4;

const unsigned FixedSizeOfSoftReference = 20;

const unsigned FixedSizeOfStackOverflowError = 16;

const unsigned FixedSizeOfStackTraceElement = 20;

const unsigned FixedSizeOfString = 20;

const unsigned FixedSizeOfSystemClassLoader = 20;

const unsigned FixedSizeOfThread = 56;

const unsigned FixedSizeOfThreadGroup = 16;

const unsigned FixedSizeOfThrowable = 16;

const unsigned FixedSizeOfTraceElement = 12;

const unsigned FixedSizeOfTreeNode = 16;

const unsigned FixedSizeOfTriple = 16;

const unsigned FixedSizeOfUnsatisfiedLinkError = 16;

const unsigned FixedSizeOfUnwindResult = 16;

const unsigned FixedSizeOfVector = 12;

const unsigned ArrayElementSizeOfVector = 4;

const unsigned FixedSizeOfVirtualMachineError = 16;

const unsigned FixedSizeOfWeakHashMap = 12;

const unsigned FixedSizeOfWeakReference = 20;

const unsigned FixedSizeOfWordArray = 8;

const unsigned ArrayElementSizeOfWordArray = 4;
...
class GcArray: public GcObject {
 public:
  ...
  void setBodyElement(Thread* t UNUSED, size_t index, object value) { setField(t, this , ArrayBody + index * (4), reinterpret_cast<object>(value)); }
};
...
class GcClass: public GcObject {
 public:
  ...
  void setVtableElement(Thread* t UNUSED, size_t index, void* value) { field_at<void*>(ClassVtable + index * (4)) = value; }
};
...
class GcContinuation: public GcObject {
 public:
  ...
  void setBodyElement(Thread* t UNUSED, size_t index, uintptr_t value) { field_at<uintptr_t>(ContinuationBody + index * (4)) = value; }
};
...
class GcSingleton: public GcObject {
 public:
  ...
  void setBodyElement(Thread* t UNUSED, size_t index, uintptr_t value) { setField(t, this , SingletonBody + index * (4), reinterpret_cast<object>(value)); }
};
...
class GcVector: public GcObject {
 public:
  ...
  void setBodyElement(Thread* t UNUSED, size_t index, object value) { setField(t, this , VectorBody + index * (4), reinterpret_cast<object>(value)); }
};
...
class GcWordArray: public GcObject {
 public:
  ...
  void setBodyElement(Thread* t UNUSED, size_t index, uintptr_t value) { field_at<uintptr_t>(WordArrayBody + index * (4)) = value; }
};
