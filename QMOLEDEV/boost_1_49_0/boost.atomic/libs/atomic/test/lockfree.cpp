...
#define EXPECT_ADDRESS_LOCK_FREE 2
...
#define EXPECT_ADDRESS_LOCK_FREE (sizeof(void *) <= 4 ? 2 : 0)
#define EXPECT_BOOL_LOCK_FREE 2
...
#define EXPECT_LLONG_LOCK_FREE 0
#define EXPECT_ADDRESS_LOCK_FREE 0
...
#endif
	verify_lock_free<void *>("void *", BOOST_ATOMIC_ADDRESS_LOCK_FREE, EXPECT_SHORT_LOCK_FREE);
