...
/* #undef OPEN_LDAP_API_AT_LEAST_3000 */
...
/* Define if bogofilter plugin is being built. */
...
/* Define if spamassassin plugin is being built. */
#define USE_SPAMASSASSIN_PLUGIN 1
