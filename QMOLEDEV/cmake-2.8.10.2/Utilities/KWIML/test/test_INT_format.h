...
#define TEST(FMT, T, U, STR) \
        TEST_(FMT, cmIML_INT_##T, cmIML_INT_##U, STR)
#define TEST2(PRI, SCN, T, U, STR) \
        TEST2_(PRI, SCN, cmIML_INT_##T, cmIML_INT_##U, STR)
#define TEST_C(C, V, PRI, T, U) \
        TEST_C_(cmIML_INT_##C, V, PRI, cmIML_INT_##T, cmIML_INT_##U)
#define TEST_PRI(PRI, T, U, STR) \
        TEST_PRI_(PRI, cmIML_INT_##T, cmIML_INT_##U, STR)
#define TEST_SCN(SCN, T, U, STR) \
        TEST_SCN_(SCN, cmIML_INT_##T, cmIML_INT_##U, STR)
#define TEST_SCN2(PRI, SCN, T, U, STR) \
        TEST_SCN2_(PRI, SCN, cmIML_INT_##T, cmIML_INT_##U, STR)
...
# if cmIML_ABI_SIZEOF_DATA_PTR == 4
