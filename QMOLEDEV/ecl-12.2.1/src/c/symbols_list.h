...
{EXT_ "*INTERRUPTS-ENABLED*", EXT_SPECIAL, NULL, 1, Ct},
...
{MP_ "LOCK-HOLDER", MP_ORDINARY, IF_MP(mp_lock_holder), 1, OBJNULL},
{MP_ "LOCK-COUNT", MP_ORDINARY, IF_MP(mp_lock_count), 1, OBJNULL},
{MP_ "LOCK-MINE-P", MP_ORDINARY, IF_MP(mp_lock_mine_p), 1, OBJNULL},
{MP_ "LOCK-COUNT-MINE", MP_ORDINARY, IF_MP(mp_lock_count_mine), 1, OBJNULL},
...
{CLOS_ "+THE-CLASS+", CLOS_ORDINARY, NULL, -1, Cnil},
{CLOS_ "+THE-STD-CLASS+", CLOS_ORDINARY, NULL, -1, Cnil},
{CLOS_ "+THE-STANDARD-CLASS+", CLOS_ORDINARY, NULL, -1, Cnil},
{CLOS_ "+THE-FUNCALLABLE-STANDARD-CLASS+", CLOS_ORDINARY, NULL, -1, Cnil},
...
{EXT_ "*HELP-MESSAGE*", EXT_SPECIAL, NULL, -1, Cnil},
{EXT_ "*LISP-INIT-FILE-LIST*", EXT_SPECIAL, NULL, -1, Cnil},
