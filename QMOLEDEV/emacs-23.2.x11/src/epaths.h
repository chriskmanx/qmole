...
/* The default search path for Lisp function "load".
   This sets load-path.  */
#define PATH_LOADSEARCH "/usr/local/share/emacs/23.2/site-lisp:/usr/local/share/emacs/site-lisp:/usr/local/share/emacs/23.2/lisp:/usr/local/share/emacs/23.2/leim"

/* Like PATH_LOADSEARCH, but used only when Emacs is dumping.  This
   path is usually identical to PATH_LOADSEARCH except that the entry
   for the directory containing the installed lisp files has been
   replaced with ../lisp.  */
#define PATH_DUMPLOADSEARCH "/home/chris/emacs-23.2.x11/lisp"
...
#define PATH_EXEC "/usr/local/libexec/emacs/23.2/arm-apple-darwin10.4.0"

/* Where Emacs should look for its architecture-independent data
   files, like the NEWS file.  The lisp variable data-directory
   is set to this value.  */
#define PATH_DATA "/usr/local/share/emacs/23.2/etc"
...
#define PATH_DOC "/usr/local/share/emacs/23.2/etc"
