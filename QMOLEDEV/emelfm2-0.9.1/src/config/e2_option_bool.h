/* $Id: e2_option_bool.h 2064 2010-03-12 13:15:36Z tpgww $
...
#ifndef __E2_OPTION_BOOL_H__
#define __E2_OPTION_BOOL_H__

E2_OptionSet *e2_option_bool_register (gchar *name, gchar *group, gchar *desc,
	gchar *tip, gchar *depends, gboolean def, E2_OptionFlags flags);
...
gboolean e2_option_bool_set (gchar *option, gboolean state);
gboolean e2_option_bool_set_direct (E2_OptionSet *set, gboolean value);

#endif //ndef __E2_OPTION_BOOL_H__
