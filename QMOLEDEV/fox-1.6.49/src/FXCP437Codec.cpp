...
static const unsigned char reverse_data[553]={
   ...
   165,  26,   26,   26,   26,   153,  26,   26,   26,   26,   26,   154,  26,   26,   225,  133,
   160,  131,  26,   132,  134,  145,  135,  138,  130,  136,  137,  141,  161,  140,  139,  26,
   164,  149,  162,  147,  26,   148,  246,  26,   151,  163,  150,  129,  26,   26,   152,  26,
...
FXint FXCP437Codec::mb2wc(FXwchar& wc,const FXchar* src,FXint nsrc) const {
  if(nsrc<1) return -1;
...
FXint FXCP437Codec::wc2mb(FXchar* dst,FXint ndst,FXwchar wc) const {
  if(ndst<1) return -1;
  dst[0]=reverse_data[reverse_block[reverse_pages[reverse_plane[wc>>16]+((wc>>10)&63)]+((wc>>4)&63)]+(wc&15)];
  return 1;
  }

FXint FXCP437Codec::mibEnum() const {
  return 2011;
  }


const FXchar* FXCP437Codec::name() const {
  return "IBM437";
  }


const FXchar* FXCP437Codec::mimeName() const {
  return "IBM437";
  }
