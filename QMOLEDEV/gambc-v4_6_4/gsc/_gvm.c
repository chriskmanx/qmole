...
; File: "_gvm.c", produced by Gambit-C v4.6.4
(
406004
" _gvm"
(" _gvm")
...
#define ___SYM_COUNT 17
#define ___GLO_COUNT 236
#define ___SUP_COUNT 195
#define ___SUB_COUNT 94
#define ___LBL_COUNT 1597
#define ___OFD_COUNT 85
#include "gambit.h"
...
___DEF_SUB_STR(___X60,7)
               ___STR7(32,106,117,109,112,42,32)
...
___DEF_SUB_STR(___X64,2)
               ___STR2(32,32)
___DEF_SUB_STR(___X65,8)
               ___STR8(115,119,105,116,99,104,42,32)
               ___STR0
___DEF_SUB_STR(___X66,1)
               ___STR1(32)
___DEF_SUB_STR(___X67,2)
               ___STR2(32,40)
___DEF_SUB_STR(___X68,7)
               ___STR7(115,119,105,116,99,104,32)
___DEF_SUB_STR(___X69,37)
               ___STR8(119,114,105,116,101,45,103,118)
               ___STR8(109,45,105,110,115,116,114,44)
               ___STR8(32,117,110,107,110,111,119,110)
...
___DEF_SUB_STR(___X70,5)
               ___STR5(106,117,109,112,42)
___DEF_SUB_STR(___X71,2)
               ___STR2(36,32)
...
___DEF_SUB_STR(___X76,3)
               ___STR3(32,61,32)
___DEF_SUB_STR(___X77,2)
               ___STR2(59,32)
___DEF_SUB_STR(___X78,1)
               ___STR1(32)
___DEF_SUB_STR(___X79,1)
               ___STR1(61)
___DEF_SUB_STR(___X80,1)
               ___STR1(46)
___DEF_SUB_STR(___X81,1)
               ___STR1(35)
___DEF_SUB_STR(___X82,1)
               ___STR1(32)
___DEF_SUB_STR(___X83,1)
               ___STR1(46)
___DEF_SUB_STR(___X84,35)
               ___STR8(119,114,105,116,101,45,103,118)
...
___DEF_GLBL(___L__20___gvm)
   ...
   ___SET_R1(___CONS(___SYM(10,___S_proc_2d_obj),___NUL))
   ___SET_GLO(163,___G_c_23_proc_2d_obj_2d_tag,___R1)
   ___SET_R1(___CONS(___SYM(1,___S_bbs),___NUL))
...
___DEF_GLBL(___L_c_23_glo_2d_name)
   ___SET_R1(___FIXQUO(___R1,___FIX(8L)))
   ___SET_R1(___VECTORREF(___GLO(1,___G_c_23__2a_opnd_2d_table_2a_),___R1))
...
___DEF_GLBL(___L_c_23_extend_2d_opnd_2d_table_21_)
   ___SET_R1(___VECTORLENGTH(___GLO(1,___G_c_23__2a_opnd_2d_table_2a_)))
   ___SET_STK(1,___R0)
   ___SET_STK(2,___R1)
...
___DEF_SLBL(1,___L1_c_23_extend_2d_opnd_2d_table_21_)
   ___JUMPPRM(___SET_NARGS(2),___PRM(231,___G_make_2d_vector))
...
___DEF_GLBL(___L5_c_23_extend_2d_opnd_2d_table_21_)
   ___SET_R4(___VECTORREF(___GLO(1,___G_c_23__2a_opnd_2d_table_2a_),___R3))
...
___DEF_GLBL(___L9_c_23_enter_2d_opnd)
   ___IF(___FIXLT(___R3,___GLO(2,___G_c_23__2a_opnd_2d_table_2d_alloc_2a_)))
   ___GOTO(___L7_c_23_enter_2d_opnd)
   ___END_IF
   ___SET_R4(___FIXADD(___GLO(2,___G_c_23__2a_opnd_2d_table_2d_alloc_2a_),___FIX(1L)))
   ___SET_GLO(2,___G_c_23__2a_opnd_2d_table_2d_alloc_2a_,___R4)
   ___SET_R4(___VECTORLENGTH(___GLO(1,___G_c_23__2a_opnd_2d_table_2a_)))
   ___IF(___NOT(___FIXGT(___GLO(2,___G_c_23__2a_opnd_2d_table_2d_alloc_2a_),___R4)))
...
___DEF_GLBL(___L10_c_23_enter_2d_opnd)
   ...
   ___VECTORSET(___GLO(1,___G_c_23__2a_opnd_2d_table_2a_),___R3,___R1)
   ___SET_R1(___R3)
...
___DEF_GLBL(___L20_c_23_frame_2d_eq_3f_)
   ...
   ___SET_STK(2,___BOOLEAN(___EQP(___STK(1),___GLO(219,___G_c_23_ret_2d_var))))
   ___SET_STK(3,___BOOLEAN(___EQP(___R4,___GLO(219,___G_c_23_ret_2d_var))))
   ___ADJFP(3)
...
___DEF_GLBL(___L26_c_23_frame_2d_eq_3f_)
   ...
   ___SET_R2(___R4)
   ___SET_R3(___GLO(208,___G_c_23_empty_2d_var))
   ___SET_R0(___LBL(13))
   ___ADJFP(8)
   ___POLL(12)
...
___DEF_GLBL(___L27_c_23_frame_2d_eq_3f_)
   ...
   ___SET_STK(8,___STK(0))
   ___SET_R3(___R4)
   ___SET_R2(___GLO(208,___G_c_23_empty_2d_var))
   ___SET_R0(___LBL(9))
   ___ADJFP(8)
   ___POLL(15)
...
___DEF_GLBL(___L_c_23_frame_2d_live_3f_)
   ...
   ___ADJFP(1)
   ___IF(___NOT(___EQP(___R1,___GLO(200,___G_c_23_closure_2d_env_2d_var))))
...
___DEF_GLBL(___L_c_23_make_2d_proc_2d_obj)
   ...
   ___ADD_VECTOR_ELEM(0,___GLO(163,___G_c_23_proc_2d_obj_2d_tag))
...
___DEF_GLBL(___L_c_23_proc_2d_obj_3f_)
   ...
   ___END_IF
   ___SET_R1(___VECTORREF(___R1,___FIX(0L)))
   ___SET_R1(___BOOLEAN(___EQP(___R1,___GLO(163,___G_c_23_proc_2d_obj_2d_tag))))
   ___JUMPPRM(___NOTHING,___R0)
...
___DEF_SLBL(2,___L2_c_23_make_2d_bbs)
   ...
   ___ADD_VECTOR_ELEM(0,___GLO(43,___G_c_23_bbs_2d_tag))
...
___DEF_GLBL(___L_c_23_bbs_3f_)
   ...
   ___END_IF
   ___SET_R1(___VECTORREF(___R1,___FIX(0L)))
   ___SET_R1(___BOOLEAN(___EQP(___R1,___GLO(43,___G_c_23_bbs_2d_tag))))
   ___JUMPPRM(___NOTHING,___R0)
...
___DEF_GLBL(___L_c_23_make_2d_label_2d_simple)
   ___BEGIN_ALLOC_VECTOR(5)
   ___ADD_VECTOR_ELEM(0,___SYM(8,___S_label))
   ___ADD_VECTOR_ELEM(1,___R2)
   ___ADD_VECTOR_ELEM(2,___R3)
   ___ADD_VECTOR_ELEM(3,___R1)
   ___ADD_VECTOR_ELEM(4,___SYM(12,___S_simple))
   ___END_ALLOC_VECTOR(5)
   ___SET_R1(___GET_VECTOR(5))
   ___CHECK_HEAP(1,4096)
...
___DEF_GLBL(___L_c_23_make_2d_label_2d_entry)
   ...
   ___ADD_VECTOR_ELEM(2,___R3)
   ___ADD_VECTOR_ELEM(3,___STK(-4))
   ___ADD_VECTOR_ELEM(4,___SYM(5,___S_entry))
...
___DEF_GLBL(___L_c_23_make_2d_label_2d_return)
   ...
   ___ADD_VECTOR_ELEM(2,___R3)
   ___ADD_VECTOR_ELEM(3,___R1)
   ___ADD_VECTOR_ELEM(4,___SYM(11,___S_return))
   ___END_ALLOC_VECTOR(5)
   ___SET_R1(___GET_VECTOR(5))
   ___CHECK_HEAP(1,4096)
...
___DEF_GLBL(___L_c_23_make_2d_label_2d_task_2d_entry)
   ...
   ___ADD_VECTOR_ELEM(2,___R3)
   ___ADD_VECTOR_ELEM(3,___R1)
   ___ADD_VECTOR_ELEM(4,___SYM(14,___S_task_2d_entry))
   ___END_ALLOC_VECTOR(5)
   ___SET_R1(___GET_VECTOR(5))
   ___CHECK_HEAP(1,4096)
...
___DEF_GLBL(___L_c_23_make_2d_label_2d_task_2d_return)
   ...
   ___ADD_VECTOR_ELEM(2,___R3)
   ___ADD_VECTOR_ELEM(3,___R1)
   ___ADD_VECTOR_ELEM(4,___SYM(15,___S_task_2d_return))
   ___END_ALLOC_VECTOR(5)
   ___SET_R1(___GET_VECTOR(5))
   ___CHECK_HEAP(1,4096)
...
___DEF_GLBL(___L_c_23_make_2d_apply)
   ...
   ___ADD_VECTOR_ELEM(0,___SYM(0,___S_apply))
   ___ADD_VECTOR_ELEM(1,___R2)
   ___ADD_VECTOR_ELEM(2,___R3)
...
___DEF_GLBL(___L_c_23_make_2d_copy)
   ___BEGIN_ALLOC_VECTOR(5)
   ___ADD_VECTOR_ELEM(0,___SYM(4,___S_copy))
   ___ADD_VECTOR_ELEM(1,___R2)
   ___ADD_VECTOR_ELEM(2,___R3)
...
___DEF_GLBL(___L_c_23_make_2d_close)
   ___BEGIN_ALLOC_VECTOR(4)
   ___ADD_VECTOR_ELEM(0,___SYM(2,___S_close))
   ___ADD_VECTOR_ELEM(1,___R2)
   ___ADD_VECTOR_ELEM(2,___R3)
   ___ADD_VECTOR_ELEM(3,___R1)
   ___END_ALLOC_VECTOR(4)
...
___DEF_GLBL(___L_c_23_make_2d_ifjump)
   ...
   ___ADD_VECTOR_ELEM(0,___SYM(6,___S_ifjump))
   ___ADD_VECTOR_ELEM(1,___R2)
   ___ADD_VECTOR_ELEM(2,___R3)
...
___DEF_GLBL(___L_c_23_make_2d_switch)
   ...
   ___ADD_VECTOR_ELEM(0,___SYM(13,___S_switch))
   ___ADD_VECTOR_ELEM(1,___R2)
   ___ADD_VECTOR_ELEM(2,___R3)
...
___DEF_GLBL(___L_c_23_make_2d_jump)
   ___BEGIN_ALLOC_VECTOR(7)
   ___ADD_VECTOR_ELEM(0,___SYM(7,___S_jump))
   ___ADD_VECTOR_ELEM(1,___R2)
   ___ADD_VECTOR_ELEM(2,___R3)
   ___ADD_VECTOR_ELEM(3,___STK(-2))
   ___ADD_VECTOR_ELEM(4,___STK(-1))
...
___DEF_GLBL(___L_c_23_make_2d_comment)
   ___SET_R1(___CONS(___SYM(3,___S_comment),___NUL))
   ___CHECK_HEAP(1,4096)
...
___DEF_SLBL(3,___L3_c_23_bbs_2d_remove_2d_jump_2d_cascades_21_)
   ...
   ___SET_R3(___VECTORREF(___STK(1),___FIX(0L)))
   ___ADJFP(1)
   ___IF(___NOT(___EQP(___R3,___SYM(6,___S_ifjump))))
...
___DEF_SLBL(15,___L15_c_23_bbs_2d_remove_2d_jump_2d_cascades_21_)
   ___IF(___EQP(___R1,___SYM(12,___S_simple)))
...
___DEF_GLBL(___L170_c_23_bbs_2d_remove_2d_jump_2d_cascades_21_)
   ...
   ___ADJFP(1)
   ___IF(___NOT(___EQP(___R2,___SYM(7,___S_jump))))
...
___DEF_GLBL(___L187_c_23_bbs_2d_remove_2d_jump_2d_cascades_21_)
   ___IF(___NOT(___EQP(___R3,___SYM(13,___S_switch))))
...
___DEF_GLBL(___L194_c_23_bbs_2d_remove_2d_jump_2d_cascades_21_)
   ___IF(___NOT(___EQP(___R3,___SYM(7,___S_jump))))
...
___DEF_SLBL(93,___L93_c_23_bbs_2d_remove_2d_jump_2d_cascades_21_)
   ...
   ___END_IF
   ___IF(___EQP(___R1,___SYM(13,___S_switch)))
   ___GOTO(___L242_c_23_bbs_2d_remove_2d_jump_2d_cascades_21_)
   ___END_IF
   ___IF(___EQP(___R1,___SYM(7,___S_jump)))
...
___DEF_SLBL(158,___L158_c_23_bbs_2d_remove_2d_jump_2d_cascades_21_)
   ...
   ___END_IF
   ___IF(___NOT(___EQP(___R1,___SYM(7,___S_jump))))
   ___GOTO(___L250_c_23_bbs_2d_remove_2d_jump_2d_cascades_21_)
   ___END_IF
   ___SET_R1(___STK(-5))
   ___SET_R0(___LBL(89))
...
___DEF_GLBL(___L85_c_23_bbs_2d_remove_2d_dead_2d_code_21_)
   ...
   ___SET_R4(___VECTORREF(___STK(1),___FIX(0L)))
   ___ADJFP(1)
   ___IF_GOTO(___EQP(___R4,___SYM(8,___S_label)),___L106_c_23_bbs_2d_remove_2d_dead_2d_code_21_)
   ___IF_GOTO(___EQP(___R4,___SYM(0,___S_apply)),___L104_c_23_bbs_2d_remove_2d_dead_2d_code_21_)
   ___IF_GOTO(___EQP(___R4,___SYM(4,___S_copy)),___L103_c_23_bbs_2d_remove_2d_dead_2d_code_21_)
   ___IF_GOTO(___EQP(___R4,___SYM(2,___S_close)),___L97_c_23_bbs_2d_remove_2d_dead_2d_code_21_)
   ___IF_GOTO(___EQP(___R4,___SYM(6,___S_ifjump)),___L101_c_23_bbs_2d_remove_2d_dead_2d_code_21_)
   ___IF_GOTO(___EQP(___R4,___SYM(13,___S_switch)),___L100_c_23_bbs_2d_remove_2d_dead_2d_code_21_)
   ___IF_GOTO(___EQP(___R4,___SYM(7,___S_jump)),___L86_c_23_bbs_2d_remove_2d_dead_2d_code_21_)
   ___SET_R1(___SUB(2))
   ___POLL(24)
...
___DEF_SLBL(18,___L18_c_23_bbs_2d_remove_2d_useless_2d_jumps_21_)
   ...
   ___SET_R1(___STK(-6))
   ___ADJFP(-4)
   ___JUMPPRM(___SET_NARGS(3),___PRM(196,___G_append))
...
___DEF_SLBL(23,___L23_c_23_bbs_2d_remove_2d_useless_2d_jumps_21_)
   ...
   ___SET_R0(___LBL(15))
   ___JUMPPRM(___SET_NARGS(1),___PRM(230,___G_length))
...
___DEF_GLBL(___L208_c_23_bbs_2d_remove_2d_common_2d_code_21_)
   ___IF(___EQP(___R3,___SYM(13,___S_switch)))
...
___DEF_SLBL(51,___L51_c_23_bbs_2d_remove_2d_common_2d_code_21_)
   ___SET_R0(___LBL(52))
   ___JUMPPRM(___SET_NARGS(1),___PRM(233,___G_reverse))
...
___DEF_SLBL(114,___L114_c_23_bbs_2d_remove_2d_common_2d_code_21_)
   ...
   ___END_IF
   ___IF_GOTO(___EQP(___STK(-7),___SYM(8,___S_label)),___L277_c_23_bbs_2d_remove_2d_common_2d_code_21_)
   ___IF_GOTO(___EQP(___STK(-7),___SYM(0,___S_apply)),___L274_c_23_bbs_2d_remove_2d_common_2d_code_21_)
   ___IF_GOTO(___EQP(___STK(-7),___SYM(4,___S_copy)),___L272_c_23_bbs_2d_remove_2d_common_2d_code_21_)
   ___IF_GOTO(___EQP(___STK(-7),___SYM(2,___S_close)),___L271_c_23_bbs_2d_remove_2d_common_2d_code_21_)
   ___IF_GOTO(___EQP(___STK(-7),___SYM(6,___S_ifjump)),___L266_c_23_bbs_2d_remove_2d_common_2d_code_21_)
   ___IF_GOTO(___EQP(___STK(-7),___SYM(13,___S_switch)),___L258_c_23_bbs_2d_remove_2d_common_2d_code_21_)
   ___IF_GOTO(___EQP(___STK(-7),___SYM(7,___S_jump)),___L254_c_23_bbs_2d_remove_2d_common_2d_code_21_)
   ___SET_R2(___STK(-9))
   ___SET_R1(___SUB(3))
   ___SET_R0(___STK(-10))
   ___POLL(115)
...
___DEF_GLBL(___L277_c_23_bbs_2d_remove_2d_common_2d_code_21_)
   ...
   ___END_IF
   ___IF_GOTO(___EQP(___R1,___SYM(12,___S_simple)),___L280_c_23_bbs_2d_remove_2d_common_2d_code_21_)
   ___IF_GOTO(___EQP(___R1,___SYM(11,___S_return)),___L280_c_23_bbs_2d_remove_2d_common_2d_code_21_)
   ___IF_GOTO(___EQP(___R1,___SYM(14,___S_task_2d_entry)),___L280_c_23_bbs_2d_remove_2d_common_2d_code_21_)
   ___IF_GOTO(___EQP(___R1,___SYM(15,___S_task_2d_return)),___L280_c_23_bbs_2d_remove_2d_common_2d_code_21_)
   ___IF_GOTO(___EQP(___R1,___SYM(5,___S_entry)),___L278_c_23_bbs_2d_remove_2d_common_2d_code_21_)
   ___SET_R1(___SUB(4))
   ___SET_R0(___STK(-10))
   ___POLL(163)
...
___DEF_GLBL(___L95_c_23_replace_2d_label_2d_references_21_)
   ...
   ___SET_R3(___VECTORREF(___STK(1),___FIX(0L)))
   ___ADJFP(1)
   ___IF_GOTO(___EQP(___R3,___SYM(0,___S_apply)),___L122_c_23_replace_2d_label_2d_references_21_)
   ___IF_GOTO(___EQP(___R3,___SYM(4,___S_copy)),___L121_c_23_replace_2d_label_2d_references_21_)
   ___IF_GOTO(___EQP(___R3,___SYM(2,___S_close)),___L118_c_23_replace_2d_label_2d_references_21_)
   ___IF_GOTO(___EQP(___R3,___SYM(6,___S_ifjump)),___L111_c_23_replace_2d_label_2d_references_21_)
   ___IF_GOTO(___EQP(___R3,___SYM(13,___S_switch)),___L117_c_23_replace_2d_label_2d_references_21_)
   ___IF_GOTO(___EQP(___R3,___SYM(7,___S_jump)),___L96_c_23_replace_2d_label_2d_references_21_)
   ___SET_R1(___SUB(5))
   ___POLL(5)
...
___DEF_GLBL(___L104_c_23_bbs_2d_order_21_)
   ...
   ___SET_R4(___VECTORREF(___STK(1),___FIX(0L)))
   ___ADJFP(1)
   ___IF(___NOT(___EQP(___R4,___SYM(6,___S_ifjump))))
...
___DEF_GLBL(___L112_c_23_bbs_2d_order_21_)
   ...
   ___SET_R2(___VECTORREF(___STK(1),___FIX(0L)))
   ___ADJFP(1)
   ___IF(___EQP(___R2,___SYM(6,___S_ifjump)))
   ___GOTO(___L118_c_23_bbs_2d_order_21_)
   ___END_IF
   ___IF(___EQP(___R2,___SYM(13,___S_switch)))
   ___GOTO(___L118_c_23_bbs_2d_order_21_)
   ___END_IF
   ___IF(___NOT(___EQP(___R2,___SYM(7,___S_jump))))
...
___DEF_GLBL(___L114_c_23_bbs_2d_order_21_)
   ___IF(___EQP(___R4,___SYM(13,___S_switch)))
   ___GOTO(___L116_c_23_bbs_2d_order_21_)
   ___END_IF
   ___IF(___EQP(___R4,___SYM(7,___S_jump)))
...
___DEF_SLBL(7,___L7_c_23_setup_2d_slots_2d_needed_21_)
   ___IF(___EQP(___R1,___SYM(8,___S_label)))
...
___DEF_GLBL(___L28_c_23_setup_2d_slots_2d_needed_21_)
   ...
   ___IF(___EQP(___R4,___SYM(8,___S_label)))
   ___GOTO(___L31_c_23_setup_2d_slots_2d_needed_21_)
   ___END_IF
   ___IF(___EQP(___R4,___SYM(6,___S_ifjump)))
   ___GOTO(___L29_c_23_setup_2d_slots_2d_needed_21_)
   ___END_IF
   ___IF(___EQP(___R4,___SYM(13,___S_switch)))
   ___GOTO(___L29_c_23_setup_2d_slots_2d_needed_21_)
   ___END_IF
   ___IF(___NOT(___EQP(___R4,___SYM(7,___S_jump))))
...
___DEF_GLBL(___L_c_23_need_2d_gvm_2d_instr)
   ...
   ___SET_R3(___VECTORREF(___STK(1),___FIX(0L)))
   ___ADJFP(1)
   ___IF_GOTO(___EQP(___R3,___SYM(8,___S_label)),___L41_c_23_need_2d_gvm_2d_instr)
   ___IF_GOTO(___EQP(___R3,___SYM(0,___S_apply)),___L40_c_23_need_2d_gvm_2d_instr)
   ___IF_GOTO(___EQP(___R3,___SYM(4,___S_copy)),___L39_c_23_need_2d_gvm_2d_instr)
   ___IF_GOTO(___EQP(___R3,___SYM(2,___S_close)),___L29_c_23_need_2d_gvm_2d_instr)
   ___IF_GOTO(___EQP(___R3,___SYM(6,___S_ifjump)),___L28_c_23_need_2d_gvm_2d_instr)
   ___IF_GOTO(___EQP(___R3,___SYM(13,___S_switch)),___L27_c_23_need_2d_gvm_2d_instr)
   ___IF_GOTO(___EQP(___R3,___SYM(7,___S_jump)),___L27_c_23_need_2d_gvm_2d_instr)
   ___SET_R2(___R1)
   ___SET_R1(___SUB(9))
   ___POLL(1)
...
___DEF_SLBL(8,___L8_c_23_write_2d_bb)
   ___SET_R1(___STK(-6))
   ___SET_R0(___LBL(2))
   ___JUMPPRM(___SET_NARGS(1),___PRM(232,___G_newline))
___DEF_SLBL(9,___L9_c_23_write_2d_bb)
   ___SET_R2(___STK(-5))
   ___SET_R1(___SUB(10))
   ___SET_R0(___LBL(10))
   ___JUMPPRM(___SET_NARGS(2),___PRM(229,___G_display))
...
___DEF_SLBL(16,___L16_c_23_write_2d_bb)
   ___SET_R2(___STK(-5))
   ___SET_R0(___LBL(17))
   ___JUMPPRM(___SET_NARGS(2),___PRM(235,___G_write))
...
___DEF_GLBL(___L107_c_23_virtual_2e_dump)
   ...
   ___SET_R0(___LBL(47))
   ___ADJFP(4)
   ___JUMPPRM(___SET_NARGS(2),___PRM(234,___G_string_3d__3f_))
...
___DEF_GLBL(___L_c_23_write_2d_gvm_2d_instr)
   ...
   ___SET_R3(___VECTORREF(___STK(1),___FIX(0L)))
   ___ADJFP(1)
   ___IF(___NOT(___EQP(___R3,___SYM(8,___S_label))))
...
___DEF_SLBL(5,___L5_c_23_write_2d_gvm_2d_instr)
   ...
   ___SET_R1(___FIXADD(___STK(-6),___R1))
   ___SET_R2(___VECTORREF(___STK(-7),___FIX(4L)))
   ___IF(___EQP(___R2,___SYM(12,___S_simple)))
   ___GOTO(___L129_c_23_write_2d_gvm_2d_instr)
   ___END_IF
   ___GOTO(___L139_c_23_write_2d_gvm_2d_instr)
___DEF_SLBL(6,___L6_c_23_write_2d_gvm_2d_instr)
___DEF_GLBL(___L129_c_23_write_2d_gvm_2d_instr)
   ___SET_STK(-6,___STK(-5))
   ___SET_STK(-5,___STK(-4))
   ___SET_STK(-4,___STK(-3))
___DEF_GLBL(___L130_c_23_write_2d_gvm_2d_instr)
   ...
   ___END_IF
___DEF_GLBL(___L131_c_23_write_2d_gvm_2d_instr)
...
___DEF_GLBL(___L132_c_23_write_2d_gvm_2d_instr)
   ___JUMPPRM(___SET_NARGS(2),___PRM(229,___G_display))
...
___DEF_GLBL(___L133_c_23_write_2d_gvm_2d_instr)
   ...
   ___GOTO(___L131_c_23_write_2d_gvm_2d_instr)
   ___END_IF
...
___DEF_SLBL(12,___L12_c_23_write_2d_gvm_2d_instr)
   ___GOTO(___L132_c_23_write_2d_gvm_2d_instr)
...
___DEF_SLBL(14,___L14_c_23_write_2d_gvm_2d_instr)
   ...
   ___SET_R2(___STK(-4))
   ___SET_R0(___LBL(15))
   ___JUMPINT(___SET_NARGS(2),___PRC(1511),___L_c_23_write_2d_frame)
...
___DEF_GLBL(___L138_c_23_write_2d_gvm_2d_instr)
   ___SET_R2(___SYM(16,___S_text))
   ___SET_R0(___LBL(16))
   ___JUMPINT(___SET_NARGS(2),___PRC(447),___L_c_23_comment_2d_get)
___DEF_GLBL(___L139_c_23_write_2d_gvm_2d_instr)
   ___IF(___NOT(___EQP(___R2,___SYM(5,___S_entry))))
...
___DEF_SLBL(24,___L24_c_23_write_2d_gvm_2d_instr)
   ...
   ___SET_R0(___LBL(25))
   ___ADJFP(4)
   ___JUMPINT(___SET_NARGS(2),___PRC(1548),___L_c_23_write_2d_gvm_2d_opnd)
...
___DEF_GLBL(___L157_c_23_write_2d_gvm_2d_instr)
   ___IF(___EQP(___R2,___SYM(11,___S_return)))
   ___GOTO(___L160_c_23_write_2d_gvm_2d_instr)
   ___END_IF
   ___IF(___EQP(___R2,___SYM(14,___S_task_2d_entry)))
   ___GOTO(___L159_c_23_write_2d_gvm_2d_instr)
   ___END_IF
   ___IF(___NOT(___EQP(___R2,___SYM(15,___S_task_2d_return))))
...
___DEF_GLBL(___L161_c_23_write_2d_gvm_2d_instr)
   ___IF(___NOT(___EQP(___R3,___SYM(0,___S_apply))))
...
___DEF_GLBL(___L162_c_23_write_2d_gvm_2d_instr)
   ___IF(___EQP(___R3,___SYM(4,___S_copy)))
   ___GOTO(___L164_c_23_write_2d_gvm_2d_instr)
   ___END_IF
   ___IF(___EQP(___R3,___SYM(2,___S_close)))
   ___GOTO(___L165_c_23_write_2d_gvm_2d_instr)
   ___END_IF
   ___IF(___EQP(___R3,___SYM(6,___S_ifjump)))
...
___DEF_SLBL(67,___L67_c_23_write_2d_gvm_2d_instr)
   ...
   ___SET_R1(___FIXADD(___STK(-3),___R1))
   ___GOTO(___L130_c_23_write_2d_gvm_2d_instr)
...
___DEF_SLBL(74,___L74_c_23_write_2d_gvm_2d_instr)
   ...
   ___SET_R2(___STK(-6))
   ___SET_R0(___LBL(26))
   ___JUMPINT(___SET_NARGS(2),___PRC(1578),___L_c_23_write_2d_gvm_2d_lbl)
...
___DEF_SLBL(82,___L82_c_23_write_2d_gvm_2d_instr)
   ___JUMPINT(___SET_NARGS(2),___PRC(1584),___L_c_23_write_2d_gvm_2d_obj)
...
___DEF_SLBL(8,___L8_c_23_write_2d_frame)
   ...
   ___END_IF
   ___IF(___EQP(___STK(-5),___GLO(200,___G_c_23_closure_2d_env_2d_var)))
...
___DEF_SLBL(23,___L23_c_23_write_2d_frame)
   ___IF(___NOT(___EQP(___STK(-4),___GLO(200,___G_c_23_closure_2d_env_2d_var))))
...
___DEF_GLBL(___L50_c_23_write_2d_frame)
   ___IF(___NOT(___EQP(___STK(-4),___GLO(219,___G_c_23_ret_2d_var))))
...
___DEF_GLBL(___L_c_23_write_2d_gvm_2d_opnd)
   ___IF(___FALSEP(___R1))
   ___GOTO(___L29_c_23_write_2d_gvm_2d_opnd)
   ___END_IF
   ___GOTO(___L31_c_23_write_2d_gvm_2d_opnd)
___DEF_SLBL(1,___L1_c_23_write_2d_gvm_2d_opnd)
   ...
   ___GOTO(___L31_c_23_write_2d_gvm_2d_opnd)
   ___END_IF
___DEF_GLBL(___L29_c_23_write_2d_gvm_2d_opnd)
   ___SET_STK(1,___R0)
   ___SET_R1(___SUB(83))
   ___SET_R0(___LBL(3))
   ___ADJFP(4)
...
___DEF_SLBL(4,___L4_c_23_write_2d_gvm_2d_opnd)
   ___GOTO(___L30_c_23_write_2d_gvm_2d_opnd)
___DEF_SLBL(5,___L5_c_23_write_2d_gvm_2d_opnd)
   ___SET_R1(___FIXADD(___R1,___FIX(1L)))
   ___POLL(6)
___DEF_SLBL(6,___L6_c_23_write_2d_gvm_2d_opnd)
___DEF_GLBL(___L30_c_23_write_2d_gvm_2d_opnd)
   ___ADJFP(-4)
   ___JUMPPRM(___NOTHING,___STK(1))
___DEF_GLBL(___L31_c_23_write_2d_gvm_2d_opnd)
   ___SET_STK(1,___R0)
   ___SET_STK(2,___R1)
   ___SET_STK(3,___R2)
   ___SET_R0(___LBL(8))
...
___DEF_SLBL(10,___L10_c_23_write_2d_gvm_2d_opnd)
   ___IF(___NOT(___FALSEP(___R1)))
   ___GOTO(___L35_c_23_write_2d_gvm_2d_opnd)
   ___END_IF
   ___SET_R1(___STK(-6))
   ___SET_R0(___LBL(11))
   ___JUMPINT(___SET_NARGS(1),___PRC(30),___L_c_23_clo_3f_)
___DEF_SLBL(11,___L11_c_23_write_2d_gvm_2d_opnd)
   ___IF(___NOT(___FALSEP(___R1)))
   ___GOTO(___L34_c_23_write_2d_gvm_2d_opnd)
   ___END_IF
   ___SET_R1(___STK(-6))
   ___SET_R0(___LBL(12))
   ___JUMPINT(___SET_NARGS(1),___PRC(38),___L_c_23_lbl_3f_)
___DEF_SLBL(12,___L12_c_23_write_2d_gvm_2d_opnd)
   ___IF(___FALSEP(___R1))
   ___GOTO(___L32_c_23_write_2d_gvm_2d_opnd)
   ___END_IF
   ___SET_R1(___FIXQUO(___STK(-6),___FIX(8L)))
   ___SET_R2(___STK(-5))
   ___SET_R0(___STK(-7))
...
___DEF_SLBL(13,___L13_c_23_write_2d_gvm_2d_opnd)
   ___ADJFP(-8)
   ___JUMPINT(___SET_NARGS(2),___PRC(1578),___L_c_23_write_2d_gvm_2d_lbl)
___DEF_GLBL(___L32_c_23_write_2d_gvm_2d_opnd)
   ___SET_R1(___STK(-6))
   ___SET_R0(___LBL(14))
   ___JUMPINT(___SET_NARGS(1),___PRC(47),___L_c_23_obj_3f_)
___DEF_SLBL(14,___L14_c_23_write_2d_gvm_2d_opnd)
   ___IF(___NOT(___FALSEP(___R1)))
   ___GOTO(___L33_c_23_write_2d_gvm_2d_opnd)
   ___END_IF
   ___SET_R2(___STK(-6))
   ___SET_R1(___SUB(84))
   ___SET_R0(___STK(-7))
...
___DEF_SLBL(15,___L15_c_23_write_2d_gvm_2d_opnd)
   ___ADJFP(-8)
   ___JUMPGLONOTSAFE(___SET_NARGS(2),201,___G_c_23_compiler_2d_internal_2d_error)
___DEF_GLBL(___L33_c_23_write_2d_gvm_2d_opnd)
   ___SET_R2(___STK(-5))
   ___SET_R1(___SUB(85))
   ___SET_R0(___LBL(16))
   ___JUMPPRM(___SET_NARGS(2),___PRM(229,___G_display))
...
___DEF_SLBL(17,___L17_c_23_write_2d_gvm_2d_opnd)
   ...
   ___ADJFP(-4)
   ___JUMPINT(___SET_NARGS(2),___PRC(1584),___L_c_23_write_2d_gvm_2d_obj)
___DEF_GLBL(___L34_c_23_write_2d_gvm_2d_opnd)
   ___SET_R1(___STK(-6))
   ___SET_R0(___LBL(1))
   ___JUMPINT(___SET_NARGS(1),___PRC(32),___L_c_23_clo_2d_base)
___DEF_GLBL(___L35_c_23_write_2d_gvm_2d_opnd)
   ___SET_R1(___STK(-6))
   ___SET_R0(___LBL(18))
...
___DEF_GLBL(___L_c_23_virtual_2e_begin_21_)
   ___SET_GLO(1,___G_c_23__2a_opnd_2d_table_2a_,___SUB(93))
...
,___DEF_LBL_RET(___H_c_23_virtual_2e_dump,___IFD(___RETN,13,4,0x27fL))
,___DEF_LBL_RET(___H_c_23_virtual_2e_dump,___IFD(___RETN,13,4,0x27fL))
,___DEF_LBL_INTRO(___H_c_23_write_2d_gvm_2d_instr,"c#write-gvm-instr",___REF_FAL,129,0)
...
,___DEF_LBL_RET(___H_c_23_write_2d_frame,___IFD(___RETI,2,4,0x3f3L))
,___DEF_LBL_INTRO(___H_c_23_write_2d_gvm_2d_opnd,"c#write-gvm-opnd",___REF_FAL,29,0)
...
___DEF_PRM(190,___G_c_23_write_2d_frame,1511)
___DEF_PRM(194,___G_c_23_write_2d_gvm_2d_opnd,1548)
___DEF_PRM(192,___G_c_23_write_2d_gvm_2d_lbl,1578)
___DEF_PRM(193,___G_c_23_write_2d_gvm_2d_obj,1584)
___DEF_PRM(185,___G_c_23_virtual_2e_begin_21_,1594)
___DEF_PRM(187,___G_c_23_virtual_2e_end_21_,1596)
___END_MOD1
