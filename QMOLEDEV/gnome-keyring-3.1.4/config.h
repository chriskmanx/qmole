...
/* The gnome-keyring version as a number */
#define GKR_VERSION 003001004
...
/* Have libcap-ng package, libcap-ng library */
/* #undef HAVE_LIBCAPNG */
...
#define ROOT_CERTIFICATES "/etc/ssl/certs"
...
/* Whether to build GPG agent or not */
#define WITH_GPG 1

/* Run p11-tests module testing */
/* #undef WITH_P11_TESTS */

/* Defined if SE Linux support is compiled in */
/* #undef WITH_SELINUX */

/* Whether to build SSH agent or not */
#define WITH_SSH 1
