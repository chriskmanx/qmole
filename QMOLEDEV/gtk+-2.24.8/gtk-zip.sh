...
ZIP=/tmp/gtk+-2.24.8.zip
DEVZIP=/tmp/gtk+-dev-2.24.8.zip
cd /usr/local

mkdir -p share/doc/gtk+-2.24.8
cp -p /home/chris/gtk+-2.24.8/COPYING share/doc/gtk+-2.24.8

mkdir -p share/doc/gtk+-dev-2.24.8
cp -p /home/chris/gtk+-2.24.8/COPYING share/doc/gtk+-dev-2.24.8
...
zip -r -D $ZIP share/doc/gtk+-2.24.8
...
zip -r $DEVZIP share/doc/gtk+-dev-2.24.8
