...
{
      13,     0,    -1,    -1,    13,    10,    14,    -1,    13,     1,
      -1,    13,    14,    -1,     5,    10,    15,     3,    10,     4,
      -1,    -1,    16,    -1,    15,    11,    16,    -1,    15,    11,
      -1,     7,    -1,     6,    -1,     8,    -1,     9,    -1
};
...
{
       0,   124,   124,   125,   126,   127,   131,   152,   153,   154,
     155,   159,   160,   161,   162
};
#endif
...
static const char *const yytname[] =
{
  ...
  "TOKBINDCODE", "\"$mod\"", "\"<modifier>\"", "\"control\"", "\"shift\"",
  "\"<whitespace>\"", "'+'", "$accept", "lines", "bindcode",
...
{
       2,     0,     1,     4,     0,     0,     5,     7,     3,    12,
      11,    13,    14,     0,     8,     0,    10,     0,     9,     6
};
...
{
       2,     3,     7,     4,    15,     4,    17,    19,     0,     8,
       5,    18,    16,     9,    10,    11,    12
};

static const yytype_int8 yycheck[] =
{
       0,     1,    10,     5,     3,     5,    10,     4,    -1,     5,
      10,    16,    11,     6,     7,     8,     9
};
...
{
       0,    13,     0,     1,     5,    10,    14,    10,    14,     6,
       7,     8,     9,    15,    16,     3,    11,    10,    16,     4
};
...
#line 132 "cfgparse.y"
    {
        ...
        KeySym sym = XKeycodeToKeysym(dpy, (yyvsp[(4) - (6)].number), level);
        char *str = XKeysymToString(sym);
        char *modifiers = modifier_to_string((yyvsp[(3) - (6)].number));
        // TODO: modifier to string
        sasprintf(&(context->result), "bindsym %s%s %s\n", modifiers, str, (yyvsp[(6) - (6)].string));
        free(modifiers);
    ;}
    break;
