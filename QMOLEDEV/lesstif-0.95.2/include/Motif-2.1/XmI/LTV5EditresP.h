/*
 * $Id: LTV5EditresP.h,v 1.1 2004/08/28 19:23:29 dannybackx Exp $
 *
...
#ifndef _XMI_LTV5EDITRESP_H
#define _XMI_LTV5EDITRESP_H
...
#if 0
void _LesstifEditResPutString8(ProtocolStream *stream, char *str);
void _LesstifEditResPut8(ProtocolStream *stream, unsigned int value);
void _LesstifEditResPut16(ProtocolStream *stream, unsigned int value);
void _LesstifEditResPut32(ProtocolStream *stream, unsigned long value);
void _LesstifEditResPutWidgetInfo(ProtocolStream *stream, WidgetInfo *info);
void _LesstifEditResResetStream(ProtocolStream *stream);

Boolean _LesstifEditResGet8(ProtocolStream *stream, unsigned char *val);
Boolean _LesstifEditResGet16(ProtocolStream *stream, unsigned short *val);
Boolean _LesstifEditResGetSigned16(ProtocolStream *stream, short *val);
Boolean _LesstifEditResGet32(ProtocolStream *stream, unsigned long *val);
Boolean _LesstifEditResGetString8(ProtocolStream *stream, char **str);
Boolean _LesstifEditResGetWidgetInfo(ProtocolStream *stream, WidgetInfo *info);
#endif

#endif /* _XMI_LTV5EDITRESP_H */
