/*
   $Header: /cvsroot/lesstif/lesstif/test/Xm-2.0/combobox/test12.c,v 1.7 2002/04/17 15:45:45 amai Exp $
...
main(int argc, char *argv[])
{
	...
	w = XtCreateWidget("name", xmComboBoxWidgetClass, shell, NULL, 0);
	XtDestroyWidget(w);
