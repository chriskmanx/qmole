/* $Header: /cvsroot/lesstif/lesstif/test/Xm-2.0/combobox/test5.c,v 1.7 2002/05/01 15:47:31 amai Exp $ */
...
/* result test 0 */
{  CWWidth | CWHeight            ,   10,   10,  418,   58, 0,0,0 }, /* combo */
...
main(int argc, char **argv)
{
  ...
  widget = XmCreateDropDownList(bb, "combo", NULL, 0);
