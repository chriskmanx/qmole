/*
   $Header: /cvsroot/lesstif/lesstif/test/Xm-2.0/container/test5.c,v 1.1 2002/04/17 15:39:44 amai Exp $
...
main(int argc, char *argv[])
{
	...
	w = XtCreateWidget("name", xmContainerWidgetClass, shell, NULL, 0);
	XtDestroyWidget(w);
