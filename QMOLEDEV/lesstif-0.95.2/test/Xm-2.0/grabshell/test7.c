/*
   $Header: /cvsroot/lesstif/lesstif/test/Xm-2.0/grabshell/test7.c,v 1.1 2002/04/17 15:50:49 amai Exp $
...
main(int argc, char *argv[])
{
	...
	w = XtCreateWidget("name", xmGrabShellWidgetClass, shell, NULL, 0);
	XtDestroyWidget(w);
