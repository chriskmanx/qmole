/*
   $Header: /cvsroot/lesstif/lesstif/test/Xm-2.1/print/test10.c,v 1.1 2002/04/17 15:47:33 amai Exp $
...
main(int argc, char *argv[])
{
	...
	w = XtCreateWidget("name", xmPrintShellWidgetClass, shell, NULL, 0);
	XtDestroyWidget(w);
