...
char *fallback[] = {
	...
	"*cascade1.background:			Red",
	"*cascade1.labelString:			Menu",
	"*cascade1.mnemonic:			M",
	"*cascade2.background:			Green",
    ...
    
{
   ...
   CWWidth | CWHeight            ,   56,   72,  105,   40, 0,0,0, /* menubar */
   CWWidth | CWHeight | CWX | CWY,    5,    5,   45,   30, 0,0,0, /* cascade1 */
   CWWidth | CWHeight | CWX | CWY,   50,    5,   50,   30, 0,0,0, /* cascade2 */ 
    };
