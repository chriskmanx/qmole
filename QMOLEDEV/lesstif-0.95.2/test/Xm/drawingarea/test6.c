/* $Header: /cvsroot/lesstif/lesstif/test/Xm/drawingarea/test6.c,v 1.7 2002/04/18 19:28:05 amai Exp $
...
main(int argc, char *argv[])
{
	...
	w = XtCreateWidget("name", xmDrawingAreaWidgetClass, shell, NULL, 0);
	XtDestroyWidget(w);
