/**
 *
 * $Header: /cvsroot/lesstif/lesstif/test/Xm/drawingarea/test7.c,v 1.9 2001/05/19 21:40:04 amai Exp $
 *
 **/
...
main(int argc, char **argv)
{
  ...
  Label = XmCreateDrawingArea(toplevel, "TestWidget", NULL, 0);
  DoTests(Label);

  printf("\nManage the DrawingArea\n");
  XtManageChild(Label);
  DoTests(Label);

  printf("\nRealize the DrawingArea\n");
