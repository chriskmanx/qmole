/* $Header: /cvsroot/lesstif/lesstif/test/Xm/drawnbutton/test6.c,v 1.5 2001/05/23 13:59:40 amai Exp $ 
...
main(int argc, char *argv[])
{
	...
	w = XtCreateWidget("name", xmDrawnButtonWidgetClass, shell, NULL, 0);
	XtDestroyWidget(w);
