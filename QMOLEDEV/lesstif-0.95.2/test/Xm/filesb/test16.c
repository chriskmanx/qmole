/* $Id: test16.c,v 1.3 2000/09/27 21:48:31 amai Exp $ */
...
main (int argc, char *argv[])
{
  ...
  ac = 0;
#if XmVERSION > 1
  fprintf(stdout, "Using XmNfileFilterStyle = XmFILTER_HIDDEN_FILES\n");
  XtSetArg(al[ac], XmNfileFilterStyle, XmFILTER_HIDDEN_FILES);
  ac++;
#endif
