/**
 *
 * $Id: test45.c,v 1.4 2001/05/16 09:19:46 amai Exp $
 *
 **/
...
XtWidgetGeometry desired;
	...
	QueryResult Expect;
		...
		Expect.geo.request_mode = XtCWQueryOnly;
...
main(int argc, char **argv)
{
  ...
  label = XmCreateLabel(Form, "TestLabelWidget", NULL, 0);
...
XtWidgetGeometry Expected[] = {
   CWWidth | CWHeight            ,  508,  524,   96,   19, 0,0,0, /* TestWidget */
   CWWidth | CWHeight | CWX | CWY,    0,    0,   92,   15, 0,0,0, /* TestWidget */
};
