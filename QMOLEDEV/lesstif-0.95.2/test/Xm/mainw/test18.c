/*
 * $Id: test18.c,v 1.1 2001/01/02 17:16:52 amai Exp $
 *
...
main(int argc, char **argv)
{
  ...
  main_window =
XtCreateManagedWidget("main_window",xmMainWindowWidgetClass,
                                       toplevel,args,1);
  ...
  
{
   ...
   CWWidth | CWHeight            ,   50,   50,  136,   17, 0,0,0, /* main_window */
   CWWidth | CWHeight | CWX | CWY,    0,    0,  136,   17, 0,0,0, /* form */
