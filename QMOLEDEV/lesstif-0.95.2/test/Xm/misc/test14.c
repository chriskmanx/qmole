/*
 * $Header: /cvsroot/lesstif/lesstif/test/Xm/misc/test14.c,v 1.5 2002/05/03 12:03:41 amai Exp $
...
main(int argc, char *argv[])
{
	...
	printf("/* $Id: test14.c,v 1.5 2002/05/03 12:03:41 amai Exp $ */\n");
	printf("/* This is the output of LESSTIF/test/Xm/test14.c */\n");
	printf("\n");
