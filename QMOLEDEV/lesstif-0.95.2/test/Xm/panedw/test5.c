  ...
  
{
   ...
   CWWidth | CWHeight | CWX | CWY,    3,    3,  138,   25, 0,0,0, /* button */
   CWWidth | CWHeight | CWX | CWY,    3,   36,  138,   31, 0,0,0, /* field */
   ...
   CWWidth | CWHeight | CWX | CWY,  124,   27,   10,   10, 0,0,0, /* sash */
   CWWidth | CWHeight | CWX | CWY,    0,   31,  144,    2, 0,0,0, /* separator */ 
    };
