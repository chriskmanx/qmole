/* $Header: /cvsroot/lesstif/lesstif/test/Xm/pushbutton/test16.c,v 1.4 2001/06/18 09:04:00 amai Exp $
...
main(int argc, char **argv)
{
	...
	two = XtVaCreateManagedWidget("Two", xmBulletinBoardWidgetClass,
			top, NULL);
	one = XtVaCreateManagedWidget("OnePushButton", xmPushButtonWidgetClass,
			two, NULL);
