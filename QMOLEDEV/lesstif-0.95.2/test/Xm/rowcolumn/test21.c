 ...
 */
/* Oh well, it's growing into a generic menu test. */
...
printf("%d %d %d %d %d %d %d %d %d %d\n",
  ...
  static XtWidgetGeometry Expected[] = {
  	CWWidth | CWHeight,		0,	0,	116,	91,	0,0,0,
  	CWWidth | CWHeight | CWX | CWY,	3,	3,	4,	25,	0,0,0,
  	CWWidth | CWHeight | CWX | CWY,	10,	3,	84,	25,	0,0,0,
  	CWWidth | CWHeight | CWX | CWY,	0,	0,	116,	31,	0,0,0,
  	CWWidth | CWHeight | CWX | CWY,	5,	5,	40,	21,	0,0,0,
  	CWWidth | CWHeight | CWX | CWY,	45,	5,	40,	21,	0,0,0,
  	CWWidth | CWHeight | CWX | CWY,	0,	31,	116,	60,	0,0,0,
  	CWWidth | CWHeight | CWX | CWY,	0,	0,	116,	35,	0,0,0,
  	CWWidth | CWHeight | CWX | CWY,	3,	3,	40,	29,	0,0,0,
  	CWWidth | CWHeight | CWX | CWY,	46,	3,	67,	29,	0,0,0,
  	CWWidth | CWHeight | CWX | CWY,	68,	35,	48,	25,	0,0,0,
  	CWWidth | CWHeight | CWX | CWY,	0,	35,	68,	25,	0,0,0,
};
