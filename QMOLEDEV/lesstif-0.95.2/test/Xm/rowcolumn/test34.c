/* $Id: test34.c,v 1.5 2000/08/29 21:59:21 dannybackx Exp $ */
...
Widget pb;
	...
	create_option(form);
	pb = XmCreatePushButton(form, "Destroy", NULL, 0);
	XtVaSetValues(pb,
		...
		NULL);
	XtManageChild(pb);
	XtAddCallback(pb, XmNactivateCallback, (XtCallbackProc)DoSomethingStupid, NULL);
	XtRealizeWidget(appshell);
  {
  static XtWidgetGeometry Expected[] = {
  	CWWidth | CWHeight,		0,	0,	185,	60,	0,0,0,
  	...
  	CWWidth | CWHeight | CWX | CWY,	0,	35,	54,	25,	0,0,0,
};
