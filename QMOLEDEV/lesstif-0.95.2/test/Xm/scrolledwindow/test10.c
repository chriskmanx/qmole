/* $Header: /cvsroot/lesstif/lesstif/test/Xm/scrolledwindow/test10.c,v 1.7 2002/05/01 15:27:19 amai Exp $ */
/*
  ...
  
{
   ...
   CWWidth | CWHeight            ,  508,  524,  428,  150, 0,0,0, /* form */
   CWWidth | CWHeight | CWX | CWY,   10,   50,  100,  100, 0,0,0, /* scrollwin */
   CWWidth | CWHeight | CWX | CWY,    4,    2,   92,   71, 0,0,0, /* ScrolledWindowClipWindow */
   ...
   CWWidth | CWHeight | CWX | CWY,   10,   10,  418,   30, 0,0,0, /* label */ 
    };
