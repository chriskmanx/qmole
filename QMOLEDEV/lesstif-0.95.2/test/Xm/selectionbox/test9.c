/* $Header: /cvsroot/lesstif/lesstif/test/Xm/selectionbox/test9.c,v 1.6 2001/06/18 14:05:31 amai Exp $
...
main(int argc, char *argv[])
{
	...
	w = XtCreateWidget("name", xmSelectionBoxWidgetClass, shell, NULL, 0);
	XtDestroyWidget(w);
