...
AppVersion=5.29.1
OutputBaseFilename=maxima-5.29.1
DefaultDirName={pf}\Maxima-5.29.1
DefaultGroupName=Maxima-5.29.1
InfoBeforeFile=interfaces\xmaxima\win32\InfoBefore.txt
InfoAfterFile=interfaces\xmaxima\win32\readme_en.txt
AllowNoIcons=yes
LicenseFile=/usr/local\share\maxima\5.29.1\doc\COPYING
...
Source: "/usr/local\*.*"; Excludes: "\bin\xmaxima.*,\bin\xmaxima,\wxMaxima,\info,\share\maxima\5.29.1\doc\html,\share\maxima\5.29.1\doc\chm"; DestDir: "{app}\";  Flags: recursesubdirs; Components: "core"
Source: "/usr/local\share\maxima\5.29.1\doc\html\intromax.html"; DestDir: "{app}\share\maxima\5.29.1\doc\html\"; Flags: ignoreversion; Components: "core"
Source: "/usr/local\share\maxima\5.29.1\doc\chm\maxima.chm"; DestDir: "{app}\share\maxima\5.29.1\doc\chm\"; Flags: ignoreversion; Components: "core"
Source: "/usr/local\share\info\*.*"; DestDir: "{app}\info\";  Flags: ignoreversion;  Components: "core"
...
; lang\spanish
Source: "/usr/local\share\info\es\*.*"; DestDir: "{app}\info\es\";  Flags: recursesubdirs;  Components: "lang\spanish"
Source: "/usr/local\share\maxima\5.29.1\doc\chm\es\maxima.chm"; DestDir: "{app}\share\maxima\5.29.1\doc\chm\es\"; Components: "lang\spanish"
; lang\portuguese
Source: "/usr/local\share\info\pt\*.*"; DestDir: "{app}\info\pt\";  Flags: recursesubdirs;  Components: "lang\portuguese"
Source: "/usr/local\share\maxima\5.29.1\doc\chm\pt\maxima.chm"; DestDir: "{app}\share\maxima\5.29.1\doc\chm\pt\"; Components: "lang\portuguese"
; lang\brazilian
Source: "/usr/local\share\info\pt_BR\*.*"; DestDir: "{app}\info\pt_BR\";  Flags: recursesubdirs;  Components: "lang\brazilian"
Source: "/usr/local\share\maxima\5.29.1\doc\chm\pt_BR\maxima.chm"; DestDir: "{app}\share\maxima\5.29.1\doc\chm\pt_BR\"; Components: "lang\brazilian"


[Icons]
; core
Name: "{group}\{cm:CommandLineMaxima}"; Filename: "{app}\bin\maxima.bat"; IconFilename: "{app}\bin\maxima-command.ico";  Components: "core"
Name: "{group}\{cm:Introduction}"; Filename: "{app}\share\maxima\5.29.1\doc\html\intromax.html"; WorkingDir: "{app}\share\maxima\5.29.1";  Components: "core"
Name: "{group}\{cm:ReferenceManual}"; Filename: "{app}\share\maxima\5.29.1\doc\chm\maxima.chm"; WorkingDir: "{app}\share\maxima\5.29.1";  Components: "core"
...
; xmaxima
Name: "{group}\XMaxima"; Filename: "{app}\bin\xmaxima.exe"; IconFilename: "{app}\share\maxima\5.29.1\xmaxima\maxima-icon.ico";  Components: "xmaxima"
Name: "{userdesktop}\XMaxima"; Filename: "{app}\bin\xmaxima.exe"; MinVersion: 4,4; Tasks: xmdesktopicon; IconFilename: "{app}\share\maxima\5.29.1\xmaxima\maxima-icon.ico";  Components: "xmaxima"

Name: "{group}\{cm:Uninstall}"; Filename:"{uninstallexe}"

; lang\spanish
Name: "{group}\{cm:ReferenceManualSpanish}"; Filename: "{app}\share\maxima\5.29.1\doc\chm\es\maxima.chm"; WorkingDir: "{app}\share\maxima\5.29.1";  Components: "lang\spanish"
; lang\portuguese
Name: "{group}\{cm:ReferenceManualPortuguese}"; Filename: "{app}\share\maxima\5.29.1\doc\chm\pt\maxima.chm"; WorkingDir: "{app}\share\maxima\5.29.1";  Components: "lang\portuguese"
; lang\brazilian
Name: "{group}\{cm:ReferenceManualBrazilianPortuguese}"; Filename: "{app}\share\maxima\5.29.1\doc\chm\pt_BR\maxima.chm"; WorkingDir: "{app}\share\maxima\5.29.1";  Components: "lang\brazilian"
