    ...
    (f2cl-lib:with-multi-array-data
      ...
      (labels ((cabs1 (cdum)
        ...
        (prog ((vt (make-array 3 :element-type 'f2cl-lib:complex16))
               ...
               (ndcol 0) (ns 0) (nu 0) (h11 0.0d0) (h12 0.0d0) (h21 0.0d0)
               (h22 0.0d0) (safmax 0.0d0) (safmin 0.0d0) (scl 0.0d0)
               (smlnum 0.0d0) (tst1 0.0d0) (tst2 0.0d0) (ulp 0.0d0)
               (alpha #C(0.0d0 0.0d0)) (beta #C(0.0d0 0.0d0))
               (cdum #C(0.0d0 0.0d0)) (refsum #C(0.0d0 0.0d0)))
