...
set maxima_prefix=/usr/local
set package=maxima
set verbose=false
set mingw_gccver=undefined
set path=%maxima_prefix%\gnuplot;%maxima_prefix%\bin;%maxima_prefix%\lib\gcc-lib\mingw32\undefined;%path%
