...
open Parsing;;
# 2 "ocaml/ocamldoc/odoc_parser.mly"
(***********************************************************************)
(*                             OCamldoc                                *)
(*                                                                     *)
...
# 44 "ocaml/ocamldoc/odoc_parser.ml"
let yytransl_const = [|
  261 (* T_PARAM *);
  262 (* T_AUTHOR *);
  263 (* T_VERSION *);
...
; (fun __caml_parser_env ->
    ...
    Obj.repr(
# 56 "ocaml/ocamldoc/odoc_parser.mly"
               ( (_1, _2) )
# 212 "ocaml/ocamldoc/odoc_parser.ml"
               : Odoc_types.see_ref * string))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 0 : string) in
    Obj.repr(
# 60 "ocaml/ocamldoc/odoc_parser.mly"
            ( Odoc_types.See_url _1 )
# 219 "ocaml/ocamldoc/odoc_parser.ml"
               : 'see_ref))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 0 : string) in
    Obj.repr(
# 61 "ocaml/ocamldoc/odoc_parser.mly"
           ( Odoc_types.See_file _1 )
# 226 "ocaml/ocamldoc/odoc_parser.ml"
               : 'see_ref))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 0 : string) in
    Obj.repr(
# 62 "ocaml/ocamldoc/odoc_parser.mly"
          ( Odoc_types.See_doc _1 )
# 233 "ocaml/ocamldoc/odoc_parser.ml"
               : 'see_ref))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 0 : string * (string option)) in
    Obj.repr(
# 66 "ocaml/ocamldoc/odoc_parser.mly"
              ( Some _1 )
# 240 "ocaml/ocamldoc/odoc_parser.ml"
               : (string * (string option)) option))
; (fun __caml_parser_env ->
    Obj.repr(
# 67 "ocaml/ocamldoc/odoc_parser.mly"
      ( None )
# 246 "ocaml/ocamldoc/odoc_parser.ml"
               : (string * (string option)) option))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 1 : 'element_list) in
    Obj.repr(
# 71 "ocaml/ocamldoc/odoc_parser.mly"
                   ( () )
# 253 "ocaml/ocamldoc/odoc_parser.ml"
               : unit))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 0 : 'element) in
    Obj.repr(
# 75 "ocaml/ocamldoc/odoc_parser.mly"
          ( () )
# 260 "ocaml/ocamldoc/odoc_parser.ml"
               : 'element_list))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 1 : 'element) in
    let _2 = (Parsing.peek_val __caml_parser_env 0 : 'element_list) in
    Obj.repr(
# 76 "ocaml/ocamldoc/odoc_parser.mly"
                       ( () )
# 268 "ocaml/ocamldoc/odoc_parser.ml"
               : 'element_list))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 0 : 'param) in
    Obj.repr(
# 80 "ocaml/ocamldoc/odoc_parser.mly"
        ( () )
# 275 "ocaml/ocamldoc/odoc_parser.ml"
               : 'element))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 0 : 'author) in
    Obj.repr(
# 81 "ocaml/ocamldoc/odoc_parser.mly"
         ( () )
# 282 "ocaml/ocamldoc/odoc_parser.ml"
               : 'element))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 0 : 'version) in
    Obj.repr(
# 82 "ocaml/ocamldoc/odoc_parser.mly"
          ( () )
# 289 "ocaml/ocamldoc/odoc_parser.ml"
               : 'element))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 0 : 'see) in
    Obj.repr(
# 83 "ocaml/ocamldoc/odoc_parser.mly"
      ( () )
# 296 "ocaml/ocamldoc/odoc_parser.ml"
               : 'element))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 0 : 'since) in
    Obj.repr(
# 84 "ocaml/ocamldoc/odoc_parser.mly"
        ( () )
# 303 "ocaml/ocamldoc/odoc_parser.ml"
               : 'element))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 0 : 'before) in
    Obj.repr(
# 85 "ocaml/ocamldoc/odoc_parser.mly"
         ( () )
# 310 "ocaml/ocamldoc/odoc_parser.ml"
               : 'element))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 0 : 'deprecated) in
    Obj.repr(
# 86 "ocaml/ocamldoc/odoc_parser.mly"
             ( () )
# 317 "ocaml/ocamldoc/odoc_parser.ml"
               : 'element))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 0 : 'raise_exc) in
    Obj.repr(
# 87 "ocaml/ocamldoc/odoc_parser.mly"
            ( () )
# 324 "ocaml/ocamldoc/odoc_parser.ml"
               : 'element))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 0 : 'return) in
    Obj.repr(
# 88 "ocaml/ocamldoc/odoc_parser.mly"
         ( () )
# 331 "ocaml/ocamldoc/odoc_parser.ml"
               : 'element))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 0 : 'custom) in
    Obj.repr(
# 89 "ocaml/ocamldoc/odoc_parser.mly"
         ( () )
# 338 "ocaml/ocamldoc/odoc_parser.ml"
               : 'element))
; (fun __caml_parser_env ->
    let _2 = (Parsing.peek_val __caml_parser_env 0 : string) in
    Obj.repr(
# 94 "ocaml/ocamldoc/odoc_parser.mly"
    (
...
# 364 "ocaml/ocamldoc/odoc_parser.ml"
               : 'param))
; (fun __caml_parser_env ->
    let _2 = (Parsing.peek_val __caml_parser_env 0 : string) in
    Obj.repr(
# 116 "ocaml/ocamldoc/odoc_parser.mly"
                  ( authors := !authors @ [ _2 ] )
# 371 "ocaml/ocamldoc/odoc_parser.ml"
               : 'author))
; (fun __caml_parser_env ->
    let _2 = (Parsing.peek_val __caml_parser_env 0 : string) in
    Obj.repr(
# 119 "ocaml/ocamldoc/odoc_parser.mly"
                   ( version := Some _2 )
# 378 "ocaml/ocamldoc/odoc_parser.ml"
               : 'version))
; (fun __caml_parser_env ->
    let _2 = (Parsing.peek_val __caml_parser_env 0 : string) in
    Obj.repr(
# 122 "ocaml/ocamldoc/odoc_parser.mly"
               ( sees := !sees @ [_2] )
# 385 "ocaml/ocamldoc/odoc_parser.ml"
               : 'see))
; (fun __caml_parser_env ->
    let _2 = (Parsing.peek_val __caml_parser_env 0 : string) in
    Obj.repr(
# 125 "ocaml/ocamldoc/odoc_parser.mly"
                 ( since := Some _2 )
# 392 "ocaml/ocamldoc/odoc_parser.ml"
               : 'since))
; (fun __caml_parser_env ->
    let _2 = (Parsing.peek_val __caml_parser_env 0 : string) in
    Obj.repr(
# 129 "ocaml/ocamldoc/odoc_parser.mly"
    (
...
# 411 "ocaml/ocamldoc/odoc_parser.ml"
               : 'before))
; (fun __caml_parser_env ->
    let _2 = (Parsing.peek_val __caml_parser_env 0 : string) in
    Obj.repr(
# 144 "ocaml/ocamldoc/odoc_parser.mly"
                      ( deprecated := Some _2 )
# 418 "ocaml/ocamldoc/odoc_parser.ml"
               : 'deprecated))
; (fun __caml_parser_env ->
    let _2 = (Parsing.peek_val __caml_parser_env 0 : string) in
    Obj.repr(
# 148 "ocaml/ocamldoc/odoc_parser.mly"
    (
...
# 442 "ocaml/ocamldoc/odoc_parser.ml"
               : 'raise_exc))
; (fun __caml_parser_env ->
    let _2 = (Parsing.peek_val __caml_parser_env 0 : string) in
    Obj.repr(
# 168 "ocaml/ocamldoc/odoc_parser.mly"
                  ( return_value := Some _2 )
# 449 "ocaml/ocamldoc/odoc_parser.ml"
               : 'return))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 1 : string) in
    let _2 = (Parsing.peek_val __caml_parser_env 0 : string) in
    Obj.repr(
# 172 "ocaml/ocamldoc/odoc_parser.mly"
                  ( customs := !customs @ [(_1, _2)] )
# 457 "ocaml/ocamldoc/odoc_parser.ml"
               : 'custom))
(* Entry main *)
