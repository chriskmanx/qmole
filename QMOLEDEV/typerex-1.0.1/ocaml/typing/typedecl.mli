...
val transl_type_decl : Env.t -> (string loc * Parsetree.type_declaration) list
  -> (Ident.t * string loc * Typedtree.type_declaration) list * Env.t

val transl_exception : Env.t -> Parsetree.core_type list ->
  Typedtree.core_type list

val transl_exn_rebind:
    Env.t -> Location.t -> Longident.t -> Path.t * exception_declaration

val transl_value_decl : Env.t -> Parsetree.value_description -> Typedtree.value_description
