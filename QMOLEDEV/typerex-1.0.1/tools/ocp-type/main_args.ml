...
let mk_save_typedtree f =
  "-save-types", Arg.Unit f, " Save information in <filename>.cmt"
;;

let mk_partial_annot f =
  "-partial-annot", Arg.Unit f, " Save even partial information in <filename>.cmt"
;;
...
module type Bytecomp_options = sig
  ...
  val _save_typedtree : unit -> unit
  val _partial_annot : unit -> unit
  val _c : unit -> unit
  val _cc : string -> unit
...
struct
  let list = [
    mk_a F._a;
    mk_annot F._annot;
    mk_save_typedtree F._save_typedtree;
    mk_partial_annot F._partial_annot;
    mk_c F._c;
    mk_cc F._cc;
    mk_cclib F._cclib;
    mk_ccopt F._ccopt;
...
module Make_type_options (F : Bytecomp_options) =
struct
  let list = [
    mk_a F._a;
    mk_annot F._annot;
