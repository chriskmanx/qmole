...
inprocess:
    rsync_service_mod.api->service_inprocess(flowp, pkt, dir, &svc_element);
    return SERVICE_INPROCESS;

success:
    rsync_service_mod.api->add_service(flowp, pkt, dir, &svc_element,
                                       APP_ID_RSYNC, NULL, NULL, NULL);
